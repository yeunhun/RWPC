...
#define MEMIF_C_SW_MINOR_VERSION                           (3)
#define MEMIF_C_SW_PATCH_VERSION                           (6)
/*******************************************************************************
**                      Version Check                                         **
*******************************************************************************/
...
{
  MemIf_JobResultType LddJobResultType = MEMIF_JOB_FAILED;  
  if (DeviceIndex >= MEMIF_NUMBER_OF_DEVICE)
  {
    /* Invalid DeviceIndex, Report error to DET */
  ...
  (P2VAR(Std_VersionInfoType, AUTOMATIC, MEMIF_APPL_DATA)VersionInfoPtr)
{
  ...
  /* polyspace-begin MISRA-C3:D4.14 [Justified:Low] "This parametern shall be check by user" */
  ...
  /* polyspace-end MISRA-C3:D4.14 [Justified:Low] "This parametern shall be check by user" */
}
#define MEMIF_STOP_SEC_CODE
#include "MemMap.h"
/* polyspace-end MISRA-C3:20.1 */
