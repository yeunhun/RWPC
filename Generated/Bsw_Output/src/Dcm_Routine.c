...
P2VAR(Dcm_MsgContextType, AUTOMATIC, DCM_APPL_DATA) pMsgContext)
{
  ...
  if((NULL_PTR != subServiceCfg) && (NULL_PTR != subServiceCfg->pSubServiceFnc))
  {
  ...
  else
  {
    ...
    else
    {
      ...
      if(LblSearchResult == DCM_TRUE)
      {
        ...
        if(LpRIDTAB->blRoutineUsed == DCM_FALSE)
        {
  ...
  if(LucSubFunction == DCM_ROUTINE_CTRL_START)
  {
    switch(LusRoutineIdentifier)
    {
      ...
      case 768 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_0300h_OTAReady_Start(LddOpStatus,
      ...
      case 45460 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_B194h_HSMConfigLockSecureDebug_Start(LddOpStatus,
				 &Dcm_GaaRoutineSignalOutData[0],
      ...
      case 45465 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_B199h_HSMSecureBootEnable_Start(LddOpStatus,
				 &Dcm_GaaRoutineSignalOutData[0],
				 &Dcm_GaaRoutineSignalOutData[1],
				&Dcm_GaaRoutineSignalOutData16[0],
				&Dcm_GusCurrentDataLength,&LddNegativeErrorCode);
				break;

      case 45466 :

				LddReturnValue = Rte_Call_RoutineServices_RID_B19Ah_HSMFTDDisable_Start(LddOpStatus,
				 &Dcm_GaaRoutineSignalOutData[0],
				 &Dcm_GaaRoutineSignalOutData[1],
				&Dcm_GaaRoutineSignalOutData16[0],
				&Dcm_GusCurrentDataLength,&LddNegativeErrorCode);
      ...
      case 45467 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_B19Bh_HSMSecureDebugEnable_Start(LddOpStatus,
				 &Dcm_GaaRoutineSignalOutData[0],
				 &Dcm_GaaRoutineSignalOutData[1],
				&Dcm_GaaRoutineSignalOutData16[0],
				&Dcm_GusCurrentDataLength,&LddNegativeErrorCode);
      ...
      case 45468 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_B19Ch_HSMConfigurationLockEnable_Start(LddOpStatus,
				 &Dcm_GaaRoutineSignalOutData[0],
				 &Dcm_GaaRoutineSignalOutData[1],
				&Dcm_GaaRoutineSignalOutData16[0],
				&Dcm_GusCurrentDataLength,&LddNegativeErrorCode);
      ...
      case 45469 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_B19Dh_HSMChallengeRequest_Start(LddOpStatus,
				 &Dcm_GaaRoutineSignalOutData[0],
				&Dcm_GusCurrentDataLength,&LddNegativeErrorCode);
				break;
      ...
      case 45470 :
				...
				LddReturnValue = Rte_Call_RoutineServices_RID_B19Eh_HSMResponseData_Start(
