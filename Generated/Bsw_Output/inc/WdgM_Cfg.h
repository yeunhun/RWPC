...
#define WDGM_CFG_SW_PATCH_VERSION                          (17)
...
#define WDGM_SW_PATCH_VERSION                              (17)
...
#define WDGM_ENABLE_DEADLINE_SUPERVISION              (STD_ON)

/* Enable or Disable Logical supervision */
#define WDGM_ENABLE_LOGICAL_SUPERVISION               (STD_ON)

/* Enable or Disable Internal Transition */
#define WDGM_ENABLE_INTERNAL_TRANSITION               (STD_ON)

/* Enable or Disable External Transition */
#define WDGM_ENABLE_EXTERNAL_TRANSITION               (STD_ON)
...
#define WDGM_TOTAL_SES                                ((WdgM_SupervisedEntityIndexType)4)

/* Maximum number of Alive Supervisions configured */
#define WDGM_MAX_ALIVESUPERVISIONS                    ((uint16)1)

/* Maximum number of Deadline Supervisions configured */
#define WDGM_MAX_DEADLINESUPERVISIONS                 ((uint16)1)

/* Maximum number of Internal Graphs configured across Supervised Entities */
#define WDGM_MAX_INTLOGICALSUPERVISIONS               ((uint16)1)

/* Maximum number of External Graphs configured across Modes */
#define WDGM_MAX_EXTLOGICALSUPERVISIONS               ((uint16)1)

/* Maximum Number of Reference Alive Supervisions cycle configured */
#define WDGM_MAX_ALIVE_SUPERVISION_REF_CYCLE          ((uint32)700)
...
#define WDGM_GAASE400CHECKPOINTS_TOTAL_COUNT ((uint16)6)
#define WDGM_GAASE500CHECKPOINTS_TOTAL_COUNT ((uint16)4)
#define WDGM_GAASE600CHECKPOINTS_TOTAL_COUNT ((uint16)4)

#define WDGM_GAAMODE0DEADLINESUPERVISION_TOTAL_COUNT ((uint16)0)
#define WDGM_GAAMODE1DEADLINESUPERVISION_TOTAL_COUNT ((uint16)1)

#define WDGM_GAAEXLSGRAPH10_TOTAL_COUNT ((uint16)4)

#define WDGM_GAAMODE0EXLOGICALSUPERVISION_TOTAL_COUNT ((uint16)0)
#define WDGM_GAAMODE1EXLOGICALSUPERVISION_TOTAL_COUNT ((uint16)1)

#define WDGM_GAAEXLSGRAPH10MAPARRAY_TOTAL_COUNT ((uint16)4)

#define WDGM_GAAINTLSGRAPHSE400MAPARRAY_TOTAL_COUNT ((uint16)2)

#define WDGM_GAAMODE0ACTIVESE_TOTAL_COUNT ((uint16)1)
#define WDGM_GAAMODE1ACTIVESE_TOTAL_COUNT ((uint16)3)

#define WDGM_GAAMODE0TRIGGER_TOTAL_COUNT ((uint8)2)
#define WDGM_GAAMODE1TRIGGER_TOTAL_COUNT ((uint8)2)
...
#define WdgMConf_WdgMSupervisedEntity_SE_WdgMELS_01       \
  ((WdgM_SupervisedEntityIdType)500)
#define WdgMConf_WdgMSupervisedEntity_SE_WdgMELS_02       \
  ((WdgM_SupervisedEntityIdType)600)

#define WdgMConf_WdgMWatchdog_WdgMWatchdog_Ext             (Watchdog_Ext)
#define WdgMConf_WdgMWatchdog_WdgMWatchdog_Int             (Watchdog_Int)

#define WdgMConf_WdgMCheckpoint_CP_WdgMTest_AS0 ((WdgM_CheckpointIdType)0)
#define WdgMConf_WdgMCheckpoint_CP_WdgMTest_DS0 ((WdgM_CheckpointIdType)4)
#define WdgMConf_WdgMCheckpoint_CP_WdgMTest_DS1 ((WdgM_CheckpointIdType)5)
#define WdgMConf_WdgMCheckpoint_CP_WdgMTest_ILS_0 ((WdgM_CheckpointIdType)1)
#define WdgMConf_WdgMCheckpoint_CP_WdgMTest_ILS_1 ((WdgM_CheckpointIdType)2)
#define WdgMConf_WdgMCheckpoint_CP_WdgMTest_ILS_2 ((WdgM_CheckpointIdType)3)
