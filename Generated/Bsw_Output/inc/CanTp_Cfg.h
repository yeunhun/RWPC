...
#define CANTP_CFG_SW_MINOR_VERSION                         (11)
#define CANTP_CFG_SW_PATCH_VERSION                         (2)
...
#define CANTP_SW_MINOR_VERSION                             (11)
#define CANTP_SW_PATCH_VERSION                             (2)
...
#define CANTP_FD_SUPPORT (STD_OFF)
...
#define CANTP_NO_OF_RXEXTFCPDUS ((uint8)2)

/* Number of  RxExtPdus */
#define CANTP_NO_OF_RXEXTPDUS ((uint8)3)

/* Number of  GaaRxSduStatic */
#define CANTP_NO_OF_RXSDUSTATIC ((uint8)3)

/* Number of  GaaRxSduMap */
#define CANTP_NO_OF_RXSDUMAP ((uint8)2)
...
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_0_Pdu_DcmIPdu_BCAN_RWPC_GST\
  ((PduIdType)0)
#define CanTpConf_CanTpTxNSdu_CanTpTxNSdu_1_Pdu_ISignalIPdu_LOCALCAN_TP_WPC_C_BDC\
  ((PduIdType)1)

/* CanTp Rx Nsdu Handle(s) */
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_0_Pdu_DcmIPdu_BCAN_GST_RWPC\
  ((PduIdType)0)
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_1_Pdu_ISignalIPdu_LOCALCAN_TP_BDC_C_WPC\
  ((PduIdType)1)
#define CanTpConf_CanTpRxNSdu_CanTpRxNSdu_2_Pdu_DcmIPdu_BCAN_GST_ALL ((PduIdType)2)
