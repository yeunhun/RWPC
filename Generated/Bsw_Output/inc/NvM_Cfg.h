 ...
 */
#define NVM_SIZE_IMMEDIATE_JOB_QUEUE        ((uint8)20)
...
#define NVM_MIRROR_BUFFER                   ((uint16)24)
...
#define NVM_TOTAL_NUM_OF_READALL_BLOCKS     13

/* Total number of blocks configured for WriteAll */
#define NVM_TOTAL_NUM_OF_WRITEALL_BLOCKS    13

/* Total number of blocks not configured for ReadAll */
#define NVM_BLOCKS_NOT_CONFIG_READALL       0

/* Total number of blocks not configured for WriteAll */
#define NVM_BLOCKS_NOT_CONFIG_WRITEALL      0
...
#define NvMConf_NvMBlockDescriptor_NvMBlock_DemPrimaryEventMemory_2\
  ((NvM_BlockIdType)6)
#define NvMConf_NvMBlockDescriptor_NvMBlock_Option         ((NvM_BlockIdType)7)
#define NvMConf_NvMBlockDescriptor_NvMBlock_Function       ((NvM_BlockIdType)8)
#define NvMConf_NvMBlockDescriptor_NvMBlock_DTCInfo        ((NvM_BlockIdType)9)
#define NvMConf_NvMBlockDescriptor_NvMBlock_SerialNO       ((NvM_BlockIdType)10)
#define NvMConf_NvMBlockDescriptor_NvMBlock_MDate          ((NvM_BlockIdType)11)
#define NvMConf_NvMBlockDescriptor_NvMBlock_PartNO         ((NvM_BlockIdType)12)
#define NvMConf_NvMBlockDescriptor_NvMBlock_Dummy          ((NvM_BlockIdType)13)
