...
#define IOHWAB_USE_VOL_MON                            (STD_ON)
...
**                      Digital Direct                                        **
*******************************************************************************/
#define IOHWAB_DIGDIR_NUM_LGC                         (13U)

#define DigDir_BCAN_WakeUp_INT                        (0U)
#define DigDir_FAN_DIAG                               (1U)
#define DigDir_LCAN_WakeUp_INT                        (2U)
#define DigDir_NFC_INTERRUPT_INT                      (3U)
#define DigDir_NFC_OPTION                             (4U)
#define DigDir_P9450_INTB_INT                         (5U)
#define DigDir_SPI_CS                                 (6U)
#define DigDir_VBATSW_EN                              (7U)
#define DigDir_VN7140AS_IN                            (8U)
#define DigDir_VN7140AS_MULTI                         (9U)
#define DigDir_VN7140AS_SEN                           (10U)
#define IoHwAbDigitalDirectLogical_BCAN_RX            (11U)
#define IoHwAbDigitalDirectLogical_LOCALCAN_RX        (12U)
...
**                      Analog Input Direct                                   **
*******************************************************************************/
#define IOHWAB_ANAINDIR_NUM_ADC_GROUPS                (5U)

#define IOHWAB_ANAINDIR_NUM_LGC                       (6U)

#define IOHWAB_ANAINDIR_MAX_BUF_LENGTH                (1U)

#define AnaInDir_ACC_Real                             (0U)
#define AnaInDir_Battery_Real                         (1U)
#define AnaInDir_Thermistor                           (2U)
#define AnaInDir_Thermistor2                          (3U)
#define AnaInDir_Thermistor3                          (4U)
...
**                      Analog Input                                          **
*******************************************************************************/
#define IOHWAB_ANAIN_NUM_LGC                          (3U)

#define IOHWAB_ANAIN_NUM_ADC_ALLGROUP                 (2U)

#define IOHWAB_ANAIN_NUM_MAX_CHS_IN_UNIT              (2U)

#define AnaIn_ACC_Real                                (0U)
#define AnaIn_Battery_Real                            (1U)
#define AnaIn_Thermistor                              (2U)

#define IOHWAB_ADCHWUNIT_MAX_NUM                      (2U)

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
extern void AdcAllGrp0Nf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"

#define IOHWAB_START_SEC_CODE
#include "MemMap.h"
extern void AdcAllGrp2Nf(void);
#define IOHWAB_STOP_SEC_CODE
#include "MemMap.h"
...
#define IOHWAB_START_SEC_VAR_CLEARED_8
#include "MemMap.h"
extern VAR(boolean, IOHWAB_VAR)IoHwAb_GblAnaInAdcIsBusyIOM[];
#define IOHWAB_STOP_SEC_VAR_CLEARED_8
#include "MemMap.h"
...
typedef struct
{
  Adc_ValueGroupType usOneChBuffer[IOHWAB_ADCHWUNIT_MAX_NUM];
...
**                      Voltage Monitoring                                    **
*******************************************************************************/
#define IOHWAB_NUM_VOLMON_LEVEL                       (2U)

#define IOHWAB_VOLMON_FILTER                          (128U)

#define IOHWAB_VOLMON_DEFAULT_VALUE                   (700U)

/* IoHwAbAdcGroup_U0C6 */
#define IOHWAB_VOLMON_ADC_CH_IDX                      (5U)

#define IOHWAB_START_SEC_CONST_8
#include "MemMap.h"
extern CONST(uint8, IOHWAB_CONST)IoHwAb_GaaVolMonMask[];
#define IOHWAB_STOP_SEC_CONST_8
#include "MemMap.h"

#define IOHWAB_START_SEC_CONST_16
#include "MemMap.h"
extern CONST(uint16, IOHWAB_CONST)IoHwAb_GaaVolMonIncr[];
#define IOHWAB_STOP_SEC_CONST_16
#include "MemMap.h"

#define IOHWAB_START_SEC_CONST_16
#include "MemMap.h"
extern CONST(uint16, IOHWAB_CONST)IoHwAb_GaaVolMonDecr[];
#define IOHWAB_STOP_SEC_CONST_16
#include "MemMap.h"
...
#define IOHWAB_ICU_NUM_LGC                            (2U)

#define Icu_NFC_INTERRUPT                             (0U)
#define Icu_P9450_INTB                                (1U)
...
#define IOHWAB_PWM_NUM_LGC                            (5U)

#define Pwm_AMBER_IND_OUT                             (0U)
#define Pwm_FAN_OUT                                   (1U)
#define Pwm_GREEN_IND_OUT1                            (2U)
#define Pwm_GREEN_IND_OUT2                            (3U)
#define Pwm_GREEN_IND_OUT3                            (4U)
