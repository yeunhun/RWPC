...
#define DEM_MAX_NUMBER_PRESTORED_FF (1)
...
#define DEM_MAX_LISTOFCOMBINEDEVENTS (9)
...
#define DEM_MAX_LISTOFDIDCLASSINDEX (3)
...
#define DEM_MAX_LISTOFENABLECONDITIONID (3)
...
#define DEM_MAX_NUMBER_OF_DTC (9)
...
#define DEM_NUMBER_OF_EVENTS (49)

/* Total DEM_NUMBER_OF_EVENT_CALLBACK entries */
#define DEM_NUMBER_OF_EVENT_CALLBACK (1)

/* Total DEM_NUMBER_OF_INDICATORS entries */
#define DEM_NUMBER_OF_INDICATORS (6)

/* Total DEM_NUMBER_OF_PRE_DEBOUNCE_COUNTER entries */
#define DEM_NUMBER_OF_PRE_DEBOUNCE_COUNTER (1)
...
#define DEM_NUM_OF_DATAELEMENTCLASS (5)

/* Total DEM_NUM_OF_DIDCLASS entries */
#define DEM_NUM_OF_DIDCLASS (3)
...
#define DEM_NUM_OF_EVENTRELATEDDATA (5)
...
#define DEM_NUM_OF_FREEZEFRAMECLASS (3)
...
#define DEM_SIZE_OF_FF_ONE_RECORD 6
...
#define DemConf_DemEventParameter_CANCM_E_BAT_FAIL         ((Dem_EventIdType)38)
#define DemConf_DemEventParameter_CANSM_E_BUS_OFF_LOCALCAN ((Dem_EventIdType)39)
#define DemConf_DemEventParameter_CANSM_E_BUS_OFF_BCAN     ((Dem_EventIdType)40)
#define DemConf_DemEventParameter_CANSM_E_MODE_CHANGE_LOCALCAN\
  ((Dem_EventIdType)41)
#define DemConf_DemEventParameter_CANSM_E_MODE_CHANGE_BCAN ((Dem_EventIdType)42)
...
#define DemConf_DemEventParameter_DATALOG_E_EVENT          ((Dem_EventIdType)49)
