...
** 1.2.14    22-Mar-2019   YH.Han       Redmine #16411                        **
** 1.2.13    04-Dec-2018   YH.Han       Redmine #14965, #14020                **
...
/* polyspace-begin MISRA-C3:D4.8 [Not a Defect] "see COMPILER013 of AUTOSAR" */
...
typedef P2FUNC(Std_ReturnType, WDGM_CODE, WdgM_RteFuncPtrType)
  (Rte_ModeType_WdgM_Mode ddModeType);
...
typedef struct
{
  ...
  #if(WDGM_ENABLE_DEADLINE_SUPERVISION == STD_ON)
  /* OsCounter ID */
  P2CONST(CounterType, AUTOMATIC, WDGM_CONST) pCounterID;
  #endif
...
/* polyspace:begin<MISRA-C3:8.6:Not a defect:Justify with annotations> global variable has one external definition */
/* polyspace:begin<MISRA-C3:8.11:Not a defect:Justify with annotations> compiler can optimize array */
#define WDGM_START_SEC_CONST_UNSPECIFIED
#include"MemMap.h"
/* polyspace<MISRA-C3:8.3:Not a defect:Justify with annotations> NULL pointer check */
