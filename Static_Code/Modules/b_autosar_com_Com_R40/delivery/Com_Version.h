...
#define COM_VERSION_AR_RELEASE_MINOR_VERSION  0
#define COM_VERSION_AR_RELEASE_REVISION_VERSION  3

/* Software Version Information */
#define COM_VERSION_SW_MAJOR_VERSION  2
#define COM_VERSION_SW_MINOR_VERSION  7
