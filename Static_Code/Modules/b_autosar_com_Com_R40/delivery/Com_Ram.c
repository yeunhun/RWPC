...
#define COM_RAM_C_SW_MINOR_VERSION  7
...
#include "MemMap.h" 
/*  Rx Ipdu Status */
VAR(uint16, COM_VAR) Com_GaaRxIpduStatus[COM_RX_IPDU_COUNT];
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
...
#include "MemMap.h" 
/*  Rx Ipdu Status */
VAR(uint16, COM_VAR)  Com_GaaRxDmStatus[COM_RX_IPDU_DM_COUNT];
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" 
#endif
...
#include "MemMap.h" 
/*  Tx Ipdu Status */
VAR(uint16, COM_VAR) Com_GaaTxIpduStatus[COM_TX_IPDU_COUNT];
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h" 
#endif
