...
********************************************************************************
** 2.7.2     27-May-2021   SM Kwon     Internal Redmine #24951, #30001        **
...
** 2.5.0     31-Jan-2020   SM Kwon     Internal Redmine #21262, #21472        **
** 2.4.2     09-Apr-2019   SM Kwon     Internal Redmine #16805                **
** 2.4.1     14-Mar-2019   SM Kwon     Internal Redmine #15874, #16272, #16344**
** 2.4.0     07-Feb-2019   SM Kwon     Internal Redmine #13931, #14067, #15832**
**                                     #14641, #15870                         **
** 2.3.0     26-Jun-2018   SM Kwon     Internal Redmine #13012                **
** 2.2.4     08-Mar-2018   Chan Kim    Internal Redmine #11906                **
...
/* polyspace-begin MISRA-C3:8.6 [Not a defect: Justify with annotations] "No Impact of this rule violation" */
...
#define COM_PCTYPES_SW_MINOR_VERSION  7
...
#define COM_TX_SIGGRP_PROPERTY_CONFIG_MASK  ((uint16)0x011C)
...
#define COM_TX_SIGGRP_PENDING_PROPERTY        ((uint16)0x0004)
#define COM_TX_SIGGRP_TRIGGERED_ON_CHANGE     ((uint16)0x0018)
#define COM_TX_SIGGRPPROP_WOREPT_CONFIG_MASK  ((uint16)0x000C)
#define COM_TX_SIGGRP_FILTER_CONFIG_MASK      ((uint16)0x0002)
#define COM_TX_GRPSIG_TRIGGERED_ON_CHANGE     ((uint16)0x0100)
#define COM_TX_SIGGRP_UB_CONFIG_MASK          ((uint16)0x0040)
#define COM_TX_SIGGRP_TMS_CONFIG_MASK         ((uint16)0x0002)
#define COM_TX_SIGGRP_TMS_STATUS_MASK         ((uint16)0x0001)
...
/*******************************************************************************
**                  Structure for Signal Group Array                          **
*******************************************************************************/
typedef struct {
  /* The index of start byte in the Signal Group */
  uint32 ulStartByte;
  /* The length of group signal */
  uint32 ulLength;
}Com_RangeOfTOCByte;
...
typedef struct
{
  ...
  /* #7744 */
  #if(COM_RX_SIGINGROUP_ARRAY_ACCESS == STD_ON)
...
typedef struct
{
  ...
  uint32 ulRam8BitStartIdx;
  uint32 ulRam16BitStartIdx;
  uint32 ulRam32BitStartIdx;
  uint32 ulRam8BitLen;
  uint32 ulRam16BitLen;
  uint32 ulRam32BitLen;
}Com_IpduGroup;
...
typedef struct
{
  ...
  #endif
  #if((COM_TX_SIGNAL_NOTIFY == STD_ON) || (COM_TX_IPDU_DM == STD_ON) || (COM_TX_IPDU_ERRORNOTIFY==STD_ON))
...
typedef struct
{
  ...
  on following formula depending upon signal group configuration:
    8: Triggered on Change for Group Signal (0x0100)
    7: Signal configured for deadline monitoring
    6: Signal configured for update bit
    5: Gateway Signal
    2-4: Signal transfer property
      001: Pending for Signal Group
      010: Triggered for Signal Group
      011: Triggered wo repetition for Signal Group
      111: Triggered on Change wo Repetition for Signal Group
      110: Triggered on Change for Signal Group
    1: Signal configured for TMS
    0: TMS Selection - reserved for intexternal use default value should be 0
  */
  uint16 usTxSigGrpConfig;
  #if(COM_TX_SIGGROUP_UB == STD_ON)
  /* Update bit mask. Generation tool should generate the value based on update
  bit position in an I-PDU */
  uint8 ucUbitMask;
  ...
  uint16 usNoOfTOCRange;
  uint16 usTOCRangeIdx;
  #endif
}Com_TxSigGrp;
#endif
...
#include "MemMap.h"
/* Global array for number of groups for each Rx Ipdu */
extern CONST(uint16, COM_CONST) Com_GaaRxIpduNoOfGrp[COM_RX_IPDU_COUNT];
...
#define COM_START_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
/* Global array for number of groups for each Tx Ipdu */
extern CONST(uint16, COM_CONST) Com_GaaTxIpduNoOfGrp[COM_TX_IPDU_COUNT];
#define COM_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
#endif
...
#include "MemMap.h"
/* Global array for TxIpduGroup structure */
extern CONST(PduIdType, COM_CONST) Com_GaaTxIpduNotIncl[COM_TX_IPDU_NOTINCL_COUNT];
#define COM_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
#endif
#endif
...
#include "MemMap.h"
/* Global array for TxIpduGroup structure */
extern CONST(PduIdType, COM_CONST) Com_GaaRxIpduNotIncl[COM_RX_IPDU_NOTINCL_COUNT];
#define COM_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
#endif
#endif
...
extern VAR(uint8, COM_VAR) Com_GaaRamIpduRepliSts[COM_RX_REPLI_STATUS_SIZE];
...
/* Change the declaration size as empty(#648) - 14.03.03 by Chan Kim START */
extern VAR(uint8, COM_VAR) Com_GaaRxRepliCount[COM_RX_REPLI_COUNT_SIZE];
/* Change the declaration size as empty(#648) - 14.03.03 by Chan Kim END */
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
#endif
...
#define COM_START_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
/* This array holds the range of TOC fields in Signal Group Array */
extern CONST(Com_RangeOfTOCByte, COM_CONST) Com_GaaRangeOfTOCByte[COM_RANGE_OF_TOC_SIZE];
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
#endif
...
extern VAR(PduLengthType, COM_VAR) Com_GaaTxDynSigLength[COM_TX_DYN_LEN_SIZE];
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
...
/* This array holds the run time changing length of Rx Dynamic signal.
   ...
   uint8_DYN */
extern VAR(PduLengthType, COM_VAR) Com_GaaRxDynSigLength[COM_RX_DYN_LEN_SIZE];
#define COM_STOP_SEC_VAR_CLEARED_UNSPECIFIED
#include "MemMap.h"
...
extern VAR(uint8, COM_VAR) Com_GaaSigGroupChangedStatus[COM_SIG_GRP_CHANGED_STATUS_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
#endif

#if(COM_RAM_INIT_8BIT_SIZE > COM_MACRO_ZERO)
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern VAR(uint8, COM_VAR) Com_GaaRamInit8Bit[COM_RAM_INIT_8BIT_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
...
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern CONST(uint8, COM_CONST) Com_GaaRamInit8BitCpy[COM_RAM_INIT_8BIT_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
#endif
#endif

#if(COM_RAM_INIT_16BIT_SIZE > COM_MACRO_ZERO)
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern VAR(uint16, COM_VAR) Com_GaaRamInit16Bit[COM_RAM_INIT_16BIT_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
...
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern CONST(uint16, COM_CONST) Com_GaaRamInit16BitCpy[COM_RAM_INIT_16BIT_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
#endif
#endif

#if(COM_RAM_INIT_32BIT_SIZE > COM_MACRO_ZERO)
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern VAR(uint32, COM_VAR) Com_GaaRamInit32Bit[COM_RAM_INIT_32BIT_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
...
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern CONST(uint32, COM_CONST) Com_GaaRamInit32BitCpy[COM_RAM_INIT_32BIT_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
#endif
#endif

#if(COM_FILTER_NEW_IS_RANGE_SIZE > COM_MACRO_ZERO)
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern const Com_FilterNewIsInRange Com_GaaFilterNewIsInRange[COM_FILTER_NEW_IS_RANGE_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
#endif

#if(COM_SIG_GRP_MASK_INFO_SIZE > COM_MACRO_ZERO)
#define COM_START_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
extern const uint8 Com_GaaSigGroupMaskInfo[COM_SIG_GRP_MASK_INFO_SIZE];
#define COM_STOP_SEC_VAR_INIT_UNSPECIFIED
#include "MemMap.h"
#endif
...
/* polyspace-end MISRA-C3:8.6 [Not a defect: Justify with annotations] "No Impact of this rule violation" */
/*******************************************************************************
**                      Function Prototypes                                   **
*******************************************************************************/
