...
** 2.7.0     31-Dec-2020   SM Kwon     Internal Redmine #27094                **
** 2.6.0     10-Sep-2020   SM Kwon     Internal Redmine #25250                **
** 2.5.1     23-Jul-2020   SM Kwon     Internal Redmine #24866                **
** 2.4.2     08-Apr-2019   SM Kwon     Internal Redmine #16805, #17121, #17124**
** 2.4.1     14-Mar-2019   SM Kwon     Internal Redmine #16344                **
** 2.4.0     07-Feb-2019   SM Kwon     Internal Redmine #13931, #14067, #15053**
                                       #15870
...
/* polyspace-begin RTE:OBAI [Not a defect: Justify with annotations] "Genderated array index in range" */
...
#define COM_MAIN_C_SW_MINOR_VERSION  7
...
static CONST(uint8, COM_CONST) Com_GaaSigMemSize[COM_FIVE] 
...
#include "MemMap.h"
static FUNC(void, COM_CODE) Com_RxSigNotifyOrReplace(
...
#define COM_START_SEC_CODE
#include "MemMap.h"
static FUNC(void, COM_CODE) Com_RxGWSigGrpProcessing
...
#define COM_START_SEC_CODE
#include "MemMap.h"
static FUNC(void, COM_CODE) Com_RxSigDMFilterReset(
                         P2CONST(Com_RxDm, AUTOMATIC, COM_CONST) LpRxDm);
#define COM_STOP_SEC_CODE
#include "MemMap.h"
#endif                         
...
#define COM_START_SEC_CODE
#include "MemMap.h"
static boolean Com_CallTxIpduCallout(PduIdType PduId, 
...
#define COM_START_SEC_CODE
#include "MemMap.h"
static FUNC(void, COM_CODE) Com_RxGWSigProcessing
...
#define COM_START_SEC_CODE
#include "MemMap.h"
static FUNC(void, COM_CODE) Com_TxUpdateDmTimers (void);
#define COM_STOP_SEC_CODE
#include "MemMap.h"
#endif
...
#define COM_START_SEC_CODE
#include "MemMap.h"
static FUNC(void, COM_CODE) Com_RxUpdateDmTimers (void);
#define COM_STOP_SEC_CODE
#include "MemMap.h"
#endif
      ...
      if((LucRxConfig & COM_RX_IPDU_DEFERRED_CONFIG_MASK) != COM_FALSE)
      {
        ...
        if((LucRxConfig & COM_RX_IPDU_SIGNAL_CONFIG_MASK) != COM_FALSE)
        {
          ...
          Com_RxSigProcessing(LpRxIpdu,
               *(PduLengthType *)Com_GaaRxPduInfoPtr[LddComRxPduId].SduLength, &LddIdsMInfo);
          #else
          Com_RxSigProcessing(LpRxIpdu,
        ...
        if(LddIdsMInfo.blIsInvRangeSigPdu == COM_TRUE)
        {
          ...
          (P2CONST(uint8, AUTOMATIC, COM_CONST)) Com_GaaRxPduInfoPtr[LddComRxPduId].SduDataPtr, 
          *(PduLengthType *)Com_GaaRxPduInfoPtr[LddComRxPduId].SduLength);
        }
        #endif
...
static FUNC(void, COM_CODE) Com_RxUpdateDmTimers(void)
{
  ...
  do
  {
    if((Com_GaaRxIpduStatus[LpRxDm->ddRxpduId] != (uint16)COM_ZERO) 
      && (Com_GaaRxDmStatus[LddDmCount] != (uint16)COM_ZERO))
    {
...
FUNC(void, COM_CODE) Com_MainFunctionTx(void)
{
  ...
  #endif
  {
    ...
    do
    {
      ...
      if(Com_GaaTxIpduStatus[LddNoOfTxIpdu] != (uint16)COM_ZERO)
      {
        ...
        if(LucTxMode != COM_TX_NONE_MODE)
        {
          ...
          #endif
          {
            ...
            if((LucTxConfig & COM_TX_IPDU_MDT_CONFIG_MASK) != COM_FALSE)
            {
              ...
              {
                #if((COM_TX_IPDU_TMS_SIG_BASED == STD_ON) || (COM_TX_IPDU_TMS_EXPLICIT == STD_ON))
                if((LucTxMode != COM_TX_PERIODIC_MODE) || ((LusTxIpduStatusBit & COM_TX_PENDING_STATUS_MASK) == COM_FALSE))
                {
        ...
        if((LpTxIpdu->ucTxConfig & COM_TX_IPDU_MDT_CONFIG_MASK) != (COM_ZERO))
        {
          ...
          if(LusTimer != (uint16)COM_ZERO)
          {
            ...
            {
              LusTxIpduStatusBit = Com_GaaTxIpduStatusBit[LddNoOfTxIpdu];
              #if((COM_TX_IPDU_TMS_SIG_BASED == STD_ON)||(COM_TX_IPDU_REPETITION == STD_ON) || \
                  (COM_TX_IPDU_TMS_EXPLICIT == STD_ON))
              /* Get the pointer to Tx Mode */
              LpTxMode = &Com_GaaTxMode[LpTxIpdu->ddTrueTxModeIndex];
              #endif
  ...
  (PduIdType LddTxIpduId)
{
  ...
  if(LpTxIpdu->ddIpduCalloutIndex != COM_INVALID_TXID_PARAM)
  {
    ...
    LblCalloutValue = Com_CallTxIpduCallout(LddTxIpduId, 
...
static FUNC(void, COM_CODE) Com_TxUpdateDmTimers(void)
{
  ...
  {  
    ...
    #endif
    if(Com_GaaTxIpduStatus[LddTxIpduIndex] != (uint16)COM_ZERO)
    {
      {
        LusTimer = 
          ...
          if((LucSigConfig & COM_RX_SIGNAL_INVALID_CONFIG_MASK) != COM_FALSE)
          {
                                                                  ...
                                                                  != COM_FALSE)
            {
                ...
                != COM_FALSE)
              {
				...
				/* polyspace-begin MISRA-C3:11.8 [Not a defect: Justify with annotations] "No Impact of this rule violation " */
                LpSignalData = 
                    (P2VAR(uint8, AUTOMATIC, COM_VAR))(LpRxInvalid->pInitValue);
               	/* polyspace-end MISRA-C3:11.8 [Not a defect: Justify with annotations] "No Impact of this rule violation " */                   
              ...
              #if(COM_RX_SIGNAL_IDSM_ENABLED == STD_ON)
              {
                if((LpRxSignal->ucRxSigConfig & COM_RX_SIGNAL_IDSM_MASK) != COM_ZERO)
                {
                  ...
                  if(LpIdsMInform->ucInvRangeSigListIndex < COM_FOUR)
                  {
                    ...
                    LpIdsMInform->aaInvRangeSigList[LpIdsMInform->ucInvRangeSigListIndex]
  ...
  do
  {
    ...
    if(LddLength >= LpRxSigGroup->ddSignalEndByte)
    {
      ...
      if((LucSigGroupConfig & COM_RX_SIGGRP_INVALID_CONFIG_MASK) != COM_FALSE)
      {
        ...
        LpRxInvOrFltSigGrp = &(Com_GaaRxInvOrFltSigGroup[LpRxSigGroup->usInvOrFltIndex]);
        ...
        do
        {
          ...
          if(LpRxSigInGrp->usSigInGrpInvOrFltIndex != COM_INVALID_NONE)
          {
            ...
            LpRxSigInGrpInvOrFlt = &(Com_GaaRxSigInGrpInvOrFlt[LpRxSigInGrp->usSigInGrpInvOrFltIndex]);
            ...
            if (LpRxSigInGrpInvOrFlt->pInvalidValue != NULL_PTR)
            {
              ...
              LpRxUnpack = &Com_GaaRxUnpack[LpRxSigInGrpInvOrFlt->ddRxUnpackIndex];
              ...
              if(((Com_GaaInvalidFuncPtr[LpRxUnpack->ucSignalType].pInvalidFuncPtr)(
                                     LpRxSigInGrpInvOrFlt->pInvalidValue, LpSignalData,
        ...
        if(COM_TRUE == LblInvalidFlag)
        {
         /* Check whether this Signal Group is configured for 'Invalid Notification' */
          ...
          else
          {
            ...
            (void)Com_PackSigGrp(LpPackSigGroup, LpRxInvOrFltSigGrp->pInitValue, LpPackSigGroup->pWrBuffer, LpRxSigGroup->pMaskingBuffer);   
            /* polyspace:end<RTE: NIP : Not a defect : No Action Planned > Initialized pointer */
          }
          #endif
        ...
        do
        {
          ...
          if(LpRxSigInGrp->pFilter != NULL_PTR)
          {
           ...
           /* Invoke the corresponding filtering function for this Rx Group Signal 
            ...
            /* polyspace:begin <RTE:COR:Not a defect:Low> The function pointer is generated by generator. It is pointing a valid function. */
            if(COM_FALSE == (((P2CONST(Com_FilterNever, AUTOMATIC, COM_CONST))
                           (LpRxSigInGrp->pFilter))->pFilterFuncPtr)
                              (LpRxSigInGrp->pFilter, LpSignalData, COM_ZERO))
            {
              /* If this Rx Group Signal had been filtered out, Set FltOutFlag to 'COM_TRUE'. */
              LblFltOutFlag = COM_TRUE;
            ...
            /* polyspace:end <RTE:COR:Not a defect:Low> The function pointer is generated by generator. It is pointing a valid function. */
          }
    ...
    else
    {
      ...
      #endif
      {
        ...
        do
        {
          ...
          LusNoOfSignalRoute = LpRxGWSigInGrp->usNoOfRouteSigInGrp;
          ...
          do
          {
            ...
            #if(COM_TX_GW_CALLOUT_SUPPORT == STD_ON)
            if(Com_GaaSigGrpGWStatus[LusNoOfSignalRoute-COM_ONE] == (uint8)COM_TRUE)            
            #endif
            {          
              LddTxSignalId = 
              (Com_SignalIdType)Com_GaaTxGWSignal[LddRouteTxIndex].ddGWTxSigIndex;
          ...
          }while(LusNoOfSignalRoute != COM_ZERO);
  ...
  boolean Mode)
{
  ...
  #endif
  {
    ...
    if(Com_GaaTxIpduStatus[PduId] > (uint16)COM_ZERO)
    {
    ...
    if(LusNoOfSignal != COM_ZERO)
    {
      ...
      do
      {
        ...
        if((LucSigConfig & COM_RX_SIGNAL_FILTER_CONFIG_MASK) != COM_FALSE)
        {
		  ...
		  /* polyspace<RTE:COR : Not a defect: Justify with annotations> No Impact of genderation handled by tool*/
            (LpRxSignal->pFilter))->pFilterFuncPtr)
...
/*******************************************************************************
** Function Name        : Com_CallRxIpduCallout                                   **
**                                                                            **
** Service ID           : NA                                                  **
**                                                                            **
** Description          : Function added for cyclomatic complexity reduction. **
...
#define COM_START_SEC_CODE
#include "MemMap.h"
boolean Com_CallRxIpduCallout(PduIdType PduId, 
...
/*******************************************************************************
** Function Name        : Com_CallTxIpduCallout                                   **
**                                                                            **
** Service ID           : NA                                                  **
**                                                                            **
** Description          : Function added for cyclomatic complexity reduction. **
...
#define COM_START_SEC_CODE
#include "MemMap.h"
/* polyspace-begin MISRA-C3:8.13 [Not a defect: Justify with annotations] "No Impact of this rule violation " */
static boolean Com_CallTxIpduCallout(PduIdType PduId, 
P2VAR(PduInfoType, AUTOMATIC, COM_VAR) PduInfoPtr)
{
  boolean LblCalloutFlag;
...
/* polyspace-end MISRA-C3:8.13 [Not a defect: Justify with annotations] "No Impact of this rule violation " */
#define COM_STOP_SEC_CODE
#include "MemMap.h"
#endif
...
/* polyspace-end RTE:OBAI [Not a defect: Justify with annotations]  */
