...
#define COM_IPDUGRP_C_SW_MINOR_VERSION  7
  ...
  boolean Initialize)
{
  ...
  if(Initialize == COM_TRUE)
  {
    ...
    /* Initialize 8BitRam Area*/
    /* polyspace +1 MISRA-C3:D4.11, RTE:STD_LIB [Not a defect: Justify with annotations] "Valid arguments are passed" */
    memcpy(&Com_GaaRamInit8Bit[LpIpduGroup->ulRam8BitStartIdx], &Com_GaaRamInit8BitCpy[LpIpduGroup->ulRam8BitStartIdx], 
                                                    LpIpduGroup->ulRam8BitLen);
    #endif
    #if(COM_RAM16BIT_INIT == STD_ON)
    /* Initialize 16BitRam Area*/
    /* polyspace +1 MISRA-C3:D4.11, RTE:STD_LIB [Not a defect: Justify with annotations] "Valid arguments are passed" */
    memcpy(&Com_GaaRamInit16Bit[LpIpduGroup->ulRam16BitStartIdx], &Com_GaaRamInit16BitCpy[LpIpduGroup->ulRam16BitStartIdx], 
                                                    LpIpduGroup->ulRam16BitLen);
    #endif
    #if(COM_RAM32BIT_INIT == STD_ON)
    /* Initialize 32BitRam Area*/
    /* polyspace +1 MISRA-C3:D4.11, RTE:STD_LIB [Not a defect: Justify with annotations] "Valid arguments are passed" */
    memcpy(&Com_GaaRamInit32Bit[LpIpduGroup->ulRam32BitStartIdx], &Com_GaaRamInit32BitCpy[LpIpduGroup->ulRam32BitStartIdx], 
                                                    LpIpduGroup->ulRam32BitLen);  
    #endif
  }
