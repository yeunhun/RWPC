...
#define COM_INIT_AR_RELEASE_MAJOR_VERSION  4
#define COM_INIT_AR_RELEASE_MINOR_VERSION  0
#define COM_INIT_AR_RELEASE_REVISION_VERSION  3

/* Software Version Information */
#define COM_INIT_SW_MAJOR_VERSION  2
#define COM_INIT_SW_MINOR_VERSION  7
