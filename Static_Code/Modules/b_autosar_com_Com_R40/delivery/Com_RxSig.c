...
** 2.5.1     27-May-2020   SM Kwon     Internal Redmine #22522                **
** 2.4.0     13-Dec-2018   SM Kwon     Internal Redmine #13931, #14067, #14789**
...
#define COM_RXSIG_C_SW_MINOR_VERSION  7
...
#include "MemMap.h"
static FUNC(uint8, COM_CODE) Com_ShadowSignalCopy
    ...
    #endif /* COM_DEV_ERROR_DETECT */
    {
      ...
      if(SignalId < COM_RX_SIG_GRPSIG_BOUNDARY)
      {
        ...
        if(LpRxSignal->pSignalBuffer != NULL_PTR)
        {
		  ...
		  if(LucSigTypeOrSize < COM_WR_FUNC_COUNT)
		  {
        ...
        if((uint16)COM_ZERO == Com_GaaRxIpduStatus[LpRxSignal->ddRxpduId])
        {
  ...
  (Com_SignalGroupIdType SignalGroupId)
{
  ...
  #endif /* COM_DEV_ERROR_DETECT */
  {
    ...
    #endif
    {
      ...
      {
        /* Check whether Rx I-PDU is enabled */
        if((uint16)COM_ZERO == Com_GaaRxIpduStatus[LpRxSigGroup->ddRxpduId])
        {
