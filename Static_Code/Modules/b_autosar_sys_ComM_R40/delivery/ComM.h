...
********************************************************************************
** 1.9.4     26-Oct-2020   JS Lim      #26236                                 **
** 1.9.3     11-Aug-2020   JS Lim      #25554                                 **
...
**                      Global Data Types                                     **
*******************************************************************************/
/* polyspace:begin<MISRA-C3:8.5:Not a defect:No action planned> No Impact of this rule violation  */
...
#define COMM_GETCHANNELBUSLOAD_SID          0x37
...
#define COMM_UNUSED(x)                   do { \
                                            if((uint32)(x) != (uint32)COMM_ZERO) {} \
                                          } while(0)

#define COMM_UNUSED_PTR(x)                do { \
                                            if((x) != NULL_PTR) {} \
                                          } while(0)
...
**                      Function Prototypes                                   **
*******************************************************************************/
/* polyspace:begin<MISRA-C3:8.5:Not a defect:Justified> condition will be executed based on the configured values */
...
#include "MemMap.h"
#endif
/* polyspace:end<MISRA-C3:8.5:Not a defect:Justified> condition will be executed based on the configured values */
#endif /* COMM_H */
