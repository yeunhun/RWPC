...
#define COMM_VERSION_AR_RELEASE_REVISION_VERSION (COMM_AR_RELEASE_REVISION_VERSION)
...
#define COMM_ETHSM_AR_RELEASE_MINOR_VERSION_H   2
#define COMM_ETHSM_AR_RELEASE_MINOR_VERSION_L   1
#endif
