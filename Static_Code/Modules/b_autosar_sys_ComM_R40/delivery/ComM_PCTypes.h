...
** 1.9.3     11-Aug-2020   JS Lim      #25552                                 **
** 1.8.1     22-Aug-2019   JS Lim      #18922                                 **
** 1.8.0     23-Oct-2018   JS Lim      #13653                                 **
** 1.7.16    19-Jul-2018   Chan Kim    #11240                                 **
** 1.7.14    19-Jun-2017   JH Jeong    #6530                                  **
** 1.0.8     20-Jun-2016   KT Kim      #4959 #5147                            **
...
#define COMM_E_WRONG_CHANNEL                  (0x03)
...
#define COMM_NOT_USED_CHANNEL_ID              ((uint8) 255)
...
typedef struct
{
  ...
  ComM_TimeType ddMinFullComMode;
...
extern CONST(uint8, COMM_CONST) ComM_GaaChannelCtrlMapping[COMM_TOTAL_CHANNELS];
#define COMM_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
#endif
...
extern CONST(ComM_UserHandleType, COMM_CONST) ComM_GaaPncToUserMapping[COMM_TOTAL_PNCS];
#define COMM_STOP_SEC_CONST_8
#include "MemMap.h"
...
/* polyspace <MISRA-C3:8.11:Not a defect:Justified> No Impact of this rule violation(Array size will fixed in linking time) */
...
extern CONST(uint8, COMM_CONST) ComM_GaaPncUserInxArr[COMM_TOTAL_PNCS];
#define COMM_STOP_SEC_CONST_8
#include "MemMap.h"
