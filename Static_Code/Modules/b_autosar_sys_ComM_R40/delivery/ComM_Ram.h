...
** 1.0.7     15-May-2015   KT Kim      Cleared error against MISRA rule       **
...
#define COMM_RAM_AR_RELEASE_REVISION_VERSION (COMM_AR_RELEASE_REVISION_VERSION)
...
extern VAR(uint16, COMM_VAR_POWER_ON_INIT) 
 ComM_GaaPncTimeCnt[COMM_TOTAL_PNCS/*COMM_TOTAL_CHANNELS*/];
...
extern VAR(uint8, COMM_VAR_POWER_ON_INIT) ComM_GaaSignalTx[COMM_TOTAL_CHANNELS][PNC_COM_MAX_LENGTH];
#define COMM_STOP_SEC_VAR_POWER_ON_CLEARED_8
#include "MemMap.h"
#endif
#endif
...
#define COMM_START_SEC_VAR_POWER_ON_CLEARED_BOOLEAN
#include "MemMap.h"/* This array contains the status of PNC for Rx EIRA */
