...
#define COMM_RAM_C_SW_MINOR_VERSION            10
...
VAR(uint16, COMM_VAR_POWER_ON_INIT) ComM_GaaPncTimeCnt[COMM_TOTAL_PNCS/*COMM_TOTAL_CHANNELS*/];
...
VAR(uint8, COMM_VAR_POWER_ON_INIT) ComM_GaaSignalTx[COMM_TOTAL_CHANNELS][PNC_COM_MAX_LENGTH];
#define COMM_STOP_SEC_VAR_POWER_ON_CLEARED_8
#include "MemMap.h"
#endif
#endif
