...
********************************************************************************
** 4.10.6    11-19-2021    KiYoung Yun  RTE Module Release Version 4.10.6     **
**                                        Change made as per #32978           **
** 4.10.5    07-28-2021    KiYoung Yun  RTE Module Release Version 4.10.5     **
** 4.10.4    04-02-2021    Gongbin Lim  RTE Module Release Version 4.10.4     **
** 4.10.3    12-21-2020    KiYoung Yun  RTE Module Release Version 4.10.3     **
** 4.10.2    09-25-2020    KiYoung Yun  RTE Module Release Version 4.10.2     **
** 4.10.1    06-26-2020    KiYoung Yun  RTE Module Release Version 4.10.1     **
** 4.10.0    04-24-2020    KiYoung Yun  RTE Module Release Version 4.10.0     **
** 4.9.0     10-18-2019    KiYoung Yun  RTE Module Release Version 4.9.0      **
** 4.8.1     06-28-2019    KiYoung Yun  RTE Module Release Version 4.8.1      **
** 4.8.0     05-08-2019    KiYoung Yun  RTE Module Release Version 4.8.0      **
** 4.7.3     03-15-2019    KiYoung Yun  RTE Module Release Version 4.7.3      **
** 4.7.2     01-31-2019    KiYoung Yun  RTE Module Release Version 4.7.2      **
** 4.7.1     10-31-2018    KiYoung Yun  RTE Module Release Version 4.7.1      **
** 4.7.0     06-29-2018    KiYoung Yun  RTE Module Release Version 4.7.0      **
** 4.6.0     03-22-2018    KiYoung Yun  RTE Module Release Version 4.6.0      **
** 4.5.1     01-26-2018    KiYoung Yun  RTE Module Release Version 4.5.1      **
** 4.5.0     12-26-2017    KiYoung Yun  RTE Module Release Version 4.5.0      **
**                         Seongmin Kim - Changes made as per #10410          **
...
#ifdef RTE_PARAMETER_DIRECTION
#ifdef IN
#error "ParameterDirection option should be removed in your command"
#endif
#define IN 
#ifdef INOUT
#error "ParameterDirection option should be removed in your command"
...
#define RTE_E_HARD_TRANSFORMER_ERROR                  0x8A
#define RTE_E_SOFT_TRANSFORMER_ERROR                  0x8C
