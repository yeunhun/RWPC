...
/*  polyspace:begin<MISRA-C:20.1:Not a defect:Justify with annotations>  No Impact of this rule violation*/
...
/* polyspace:end<MISRA-C:11.1:Not a defect:Justify with annotations> No Impact of this rule violation */
...
#define CANIF_START_SEC_CONST_8
#include "MemMap.h"
/* polyspace +1 DEFECT:DEAD_CODE [Not a defect:Medium] "Define value will be changed by generated file." */
CONST(uint8, CANIF_CONST) CanIf_dlc_check_enable = CANIF_DLC_CHECK_ENABLED;
#define CANIF_STOP_SEC_CONST_8
#include "MemMap.h"

#define CANIF_START_SEC_CONST_8
#include "MemMap.h"
CONST(uint8, CANIF_CONST) CanIf_ctrldrv_tx_cancellation = CANIF_CTRLDRV_TX_CANCELLATION;
#define CANIF_STOP_SEC_CONST_8
#include "MemMap.h"
/* polyspace:end<MISRA-C:20.1:Not a defect:Justify with annotations>  No Impact of this rule violation*/
...
P2CONST(CanIf_RxLpdu, AUTOMATIC,CANIF_VAR) CanIf_GaaRxLpduSelect;
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
...
P2CONST(CanIf_TxLpdu,AUTOMATIC, CANIF_CONST) CanIf_GaaTxLpduSelect;
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
...
P2CONST(CanIf_ControllerConfigType, AUTOMATIC, CANIF_CONST) CanIf_GaaControllerConfigTypeSelect;
#define CANIF_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h"
