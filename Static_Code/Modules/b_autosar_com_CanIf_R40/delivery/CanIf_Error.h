...
#define CANIF_ERROR_SW_MINOR_VERSION  ((uint8)0)
...
/* This Error code is used when CAN FD DLC is incorrect */
#define CANIF_CANFD_CANIDTYPE_DLC_ERROR(CANIF_API_ID, LenStdRetVal)                \
	  do{																		  \
	if (((uint8)E_OK == (LenStdRetVal)) && ((NULL_PTR != PduInfoPtr) && 			 \
...
/* polyspace:begin<MISRA-C:18.1:Not a defect:Justify with annotations> Pointer is not outside its bounds - Pointer is generated by Generator*/
...
/* polyspace:end<MISRA-C:18.1:Not a defect:Justify with annotations> Pointer is not outside its bounds - Pointer is generated by Generator*/
...
/* polyspace +1 MISRA-C3:14.3 [Not a defect: Justified] "Condition will be executed based on the configured values" */
...
/* polyspace-begin MISRA-C3:10.4 [Not a defect:Low] "No Impact of this rule violation" */
...
/* polyspace-end MISRA-C3:10.4 [Not a defect:Low] "No Impact of this rule violation" */
