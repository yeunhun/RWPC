...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmHmacSha256Generate.h                                **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_HAEHSMHMACSHA256GENERATE_H
#define CRY_HAEHSMHMACSHA256GENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaeHsmHmacSha256GenerateStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr);

extern Std_ReturnType Cry_HaeHsmHmacSha256GenerateUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_HaeHsmHmacSha256GenerateFinish(Csm_ConfigIdType cfgId,
  uint8* resultPtr, uint32* resultLengthPtr, boolean TruncationIsAllowed);

extern void Cry_HaeHsmHmacSha256GenerateMainFunction(void);
...
#endif /* CRY_HAEHSMHMACSHA256GENERATE_H */
