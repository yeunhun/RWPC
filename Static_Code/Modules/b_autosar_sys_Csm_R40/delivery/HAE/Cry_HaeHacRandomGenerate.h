...
**                                                                            **
**  SRC-MODULE: Cry_HaeHacRandomGenerate.h                                    **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_HAEHACRANDOMGENERATE_H
#define CRY_HAEHACRANDOMGENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaeHacRandomGenerate(const void* cfgPtr,
  uint8* resultPtr, uint32 resultLength);

extern void Cry_HaeHacRandomGenerateMainFunction(void);
...
#endif /* CRY_HAEHACRANDOMGENERATE_H */
