...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmPkcs1V15Sha256Verify.c                              **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
**                      Include Section                                       **
*******************************************************************************/
#include "Cry_HaeHsmPkcs1V15Sha256Verify.h"
...
} Cry_HaeHsmPkcs1V15Sha256VerifyTransferBuffer;
...
static uint8 Cry_GaaHaeHsmPkcs1V15Sha256Digest[SHA256_DIGEST_SIZE];
...
static HSMAPI_CTX_t Cry_GddHaeHsmPkcs1V15Sha256VerifyContext;

static Cry_HaeHsmPkcs1V15Sha256VerifyTransferBuffer Cry_GddHaeHsmPkcs1V15Sha256VerifyTb;
...
#include "MemMap.h"
/*******************************************************************************
** Function Name      : Cry_HaeHsmPkcs1V15Sha256VerifyInit                    **
**                                                                            **
** Service ID         : None                                                  **
**                                                                            **
...
**                      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb                   **
**                      Cry_GddHaeHsmPkcs1V15Sha256VerifyContext,             **
**                      Cry_GaaHaeHsmPkcs1V15Sha256Digest,                    **
**                                                                            **
**                      Function(s) invoked: None                             **
*******************************************************************************/
void Cry_HaeHsmPkcs1V15Sha256VerifyInit(void)
{
  /* Initialize the module data variables to default values */
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState = NO_JOB;
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr = NULL_PTR;
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pDataPtr = NULL_PTR;
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ulDataLength = CSM_ZERO;
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pSignaturePtr = NULL_PTR;
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ulSignatureLength = CSM_ZERO;
  Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pResultPtr = NULL_PTR;

  (void)memset((void*)&Cry_GddHaeHsmPkcs1V15Sha256VerifyContext, 0x00,
    sizeof(HSMAPI_CTX_t));

  (void)memset((void*)Cry_GaaHaeHsmPkcs1V15Sha256Digest, 0x00, SHA256_DIGEST_SIZE);
}

/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1V15Sha256VerifyStart                 **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Cry_HaeHsmPkcs1V15Sha256VerifyMainFunction() can    **
...
**                        HSM_HaeGetErrorCode                                 **
*******************************************************************************/
Std_ReturnType Cry_HaeHsmPkcs1V15Sha256VerifyStart(const void* cfgPtr,
  const Csm_AsymPublicKeyType* keyPtr)
{
  ...
  if (NO_JOB == Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState)
  {
    Cry_HaeHsmPkcs1V15Sha256VerifyInit();

    Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState = JOB_START;
    ...
    if (Csm_SignatureVerifyServiceHasCallback() == FALSE)
    {
      ...
      if (LddReturnValue == E_OK)
      {
        Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState = JOB_DONE;
      }
      else
      {
        Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState = NO_JOB;
    ...
    {
      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr = keyPtr;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1V15Sha256VerifyUpdate                **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        HSM_CancelJob                                       **
*******************************************************************************/
Std_ReturnType Cry_HaeHsmPkcs1V15Sha256VerifyUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength)
{
  ...
  if (JOB_DONE == Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState)
  {
    Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState = JOB_UPDATE;
    ...
    if (Csm_SignatureVerifyServiceHasCallback() == FALSE)
    {
      ...
      if (LddReturnValue == E_OK)
      {
        LddReturnValue = HSM_Sha256Finish(
          &LddHaeHsmSha256Context, Cry_GaaHaeHsmPkcs1V15Sha256Digest);
      }
    ...
    {
      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pDataPtr = dataPtr;
      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ulDataLength = dataLength;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1V15Sha256VerifyFinish                **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        HSM_CancelJob                                       **
*******************************************************************************/
Std_ReturnType Cry_HaeHsmPkcs1V15Sha256VerifyFinish(Csm_ConfigIdType cfgId,
  ...
  Csm_VerifyResultType* resultPtr)
{
  ...
  if (JOB_DONE == Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState)
  {
    Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState = JOB_FINISH;
    ...
    if (Csm_SignatureVerifyServiceHasCallback() == FALSE)
    {
      ...
      if (LddReturnValue == E_OK)
      {
        LddReturnValue = HSM_RsaPkcs1v15VerifyUpdate(
          &Cry_GddHaeHsmPkcs1V15Sha256VerifyContext,
          (const uint8*)Cry_GaaHaeHsmPkcs1V15Sha256Digest,
          signaturePtr);
        ...
        if (LddReturnValue == E_OK)
        {
          ...
          do
          {
            LddReturnValue = HSM_WaitResp(Cry_GddHaeHsmPkcs1V15Sha256VerifyContext.jobId);
            LulTimeout++;
          } while ((LddReturnValue == HSM_E_WAIT) && (LulTimeout < CRYPTOLIB_HAE_HSM_TIMEOUT));

          if (LddReturnValue != E_OK)
          {
            (void)HSM_CancelJob(Cry_GddHaeHsmPkcs1V15Sha256VerifyContext.jobId);
          }
        }
        ...
        if (LddReturnValue == E_OK)
        {
          LddReturnValue = HSM_RsaPkcs1v15VerifyFinish(
            &Cry_GddHaeHsmPkcs1V15Sha256VerifyContext, &LucVerifyResult);
    ...
    {
      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pSignaturePtr = signaturePtr;
      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ulSignatureLength = signatureLength;
      Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pResultPtr = resultPtr;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1V15Sha256VerifyMainFunction          **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Cry_HaeHsmPkcs1V15Sha256VerifyStart() or            **
**                        Cry_HaeHsmPkcs1V15Sha256VerifyUpdate(). For         **
**                        Cry_HaeHsmPkcs1V15Sha256VerifyFinish invocation of  **
...
**                        HSM_CancelJob                                       **
*******************************************************************************/
void Cry_HaeHsmPkcs1V15Sha256VerifyMainFunction(void)
{
  Std_ReturnType LddReturnValue;
  uint16 LusKeyNum;
  HSMAPI_CTX_t LddHaeHsmSha256Context;
  ...
  switch (Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ucJobState)
  {
  case JOB_START:
    LusKeyNum = CSM_ZERO;
    ...
    if (Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr->length == CSM_ONE)
    {
      LusKeyNum = Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr->data[CSM_ZERO];
    }
    else if (Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr->length == CSM_TWO)
    {
      LusKeyNum = Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr->data[CSM_ZERO];
      /* polyspace +1 MISRA-C3:10.6,10.7,12.2 [Justified:Low] "No Impact of this rule violation" */
      LusKeyNum |= (Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pPublicKeyPtr->data[CSM_ONE]) << 8;
    }
    else
    {
      LddReturnValue = E_NOT_OK;
  ...
  case JOB_UPDATE:
    ...
    if (LddReturnValue == E_OK)
    {
      ...
      LulRemainingLength = Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ulDataLength;
      LpData = Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pDataPtr;
  ...
  case JOB_FINISH:
    if (Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.ulSignatureLength < HAC_RSA_BYTES_SIZE)
    {
      LddReturnValue = E_NOT_OK;
    }
    ...
    if (LddReturnValue == E_OK)
    {
      LddReturnValue = HSM_RsaPkcs1v15VerifyUpdate(
        &Cry_GddHaeHsmPkcs1V15Sha256VerifyContext,
        (const uint8*)Cry_GaaHaeHsmPkcs1V15Sha256Digest,
        Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pSignaturePtr);
	  ...
	  /* polyspace +8 MISRA-C3:18.1,D4.1 RTE:IDP [Justified:Low] "No Impact of this rule violation" */
          if (LucVerifyResult == (uint8)HSM_VERIFY_SUCCESS)
          {
            *(Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pResultPtr) = CSM_E_VER_OK;
          }
          else
          {
            *(Cry_GddHaeHsmPkcs1V15Sha256VerifyTb.pResultPtr) = CSM_E_VER_NOT_OK;
          }
        }
      }
...
#endif /* (CSM_SIGNATURE_HAEHSMPKCS1V15SHA256VERIFY == STD_ON) */
