...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmPkcs1PssSha256Generate.c                            **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
**  PRODUCT   : AUTOSAR Crypto Service Manager Module                         **
**                                                                            **
**  PURPOSE   : Implementation of CRY Pkcs1PssSha256 Generate Interface       **
**                                                                            **
...
**                      Include Section                                       **
*******************************************************************************/
/* Header File for HAE HSM Pkcs1Pss Sha256 */
#include "Cry_HaeHsmPkcs1PssSha256Generate.h"
/* Signature Interface */
...
**                      Global Data Types                                     **
*******************************************************************************/
/* Cry HAEHSMPkcs1PssSha256Generate Transfer buffer*/
typedef struct
{
  /* Define job state */
  uint8 ucJobState;
...
} Cry_HaeHsmPkcs1PssSha256GenerateTransferBuffer;
...
static HSMAPI_CTX_t Cry_GddHaeHsmPkcs1PssSha256GenerateContext;

/* Global structure variable for HSM Pkcs1Pss Sha256 transfer buffer */
static Cry_HaeHsmPkcs1PssSha256GenerateTransferBuffer Cry_GddHaeHsmPkcs1PssSha256GenerateTb;
...
#include "MemMap.h"
/*******************************************************************************
** Function Name      : Cry_HaeHsmPkcs1PssSha256GenerateInit                  **
**                                                                            **
** Service ID         : None                                                  **
**                                                                            **
...
**                      Cry_GddHaeHsmPkcs1PssSha256GenerateTb                 **
**                                                                            **
**                     Function(s) invoked: None                              **
**                                                                            **
*******************************************************************************/
void Cry_HaeHsmPkcs1PssSha256GenerateInit(void)
{
  /* Initialize the module data variables to default values */
  Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState = NO_JOB;
  Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr = NULL_PTR;
  Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pDataPtr = NULL_PTR;
  Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ulDataLength = CSM_ZERO;
  Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultPtr = NULL_PTR;
  Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultLengthPtr = NULL_PTR;


  (void)memset((void*)&Cry_GddHaeHsmPkcs1PssSha256GenerateContext, 0x00, sizeof(HSMAPI_CTX_t));
}

/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1PssSha256GenerateStart               **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Cry_HaeHsmPkcs1PssSha256GenerateMainFunction() can  **
...
** Remarks              : Global Variable(s)  :                               **
**                        Cry_GddHaeHsmPkcs1PssSha256GenerateTb               **
**                        Cry_GddHaeHsmPkcs1PssSha256GenerateContext,         **
**                                                                            **
**                        Function(s) invoked :                               **
**                        Cry_HaeHsmPkcs1PssSha256GenerateInit,               **
**                        Csm_SignatureGenerateServiceHasCallback,            **
**                        HSM_RsaPkcs1PssSignStart                            **
**                        HSM_HaeGetErrorCode                                 **
*******************************************************************************/
/* polyspace MISRA-C3:5.1 [Justified:Low] "Follow AUTOSAR standard naming rules" */
Std_ReturnType Cry_HaeHsmPkcs1PssSha256GenerateStart(const void *cfgPtr,
  const Csm_AsymPrivateKeyType *keyPtr)
{
  ...
  if (NO_JOB == Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState)
  {
    /* Init all the module variables with default values */
    Cry_HaeHsmPkcs1PssSha256GenerateInit();

    /* Set the job state to JOB_START */
    Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState = JOB_START;
    ...
    if (Csm_SignatureGenerateServiceHasCallback() == FALSE)
    {
      ...
      {
        LddReturnValue = HSM_RsaPkcs1PssSignStart(
          &Cry_GddHaeHsmPkcs1PssSha256GenerateContext,
          LusKeyNum);
      ...
      if (LddReturnValue == E_OK)
      {
        ...
        Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState = JOB_DONE;
      }
      else
      {
        Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState = NO_JOB;
    ...
    {
      Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr = keyPtr;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1PssSha256GenerateUpdate              **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        HSM_RsaPkcs1PssSignUpdate, HSM_WaitResp,            **
**                        HSM_HaeGetErrorCode                                 **
**                        HSM_CancelJob                                       **
*******************************************************************************/

Std_ReturnType Cry_HaeHsmPkcs1PssSha256GenerateUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength)
{
  ...
  if (JOB_DONE == Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState)
  {
    /* Set the job state to JOB_UPDATE */
    Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState = JOB_UPDATE;
    ...
    if (Csm_SignatureGenerateServiceHasCallback() == FALSE)
    {
      ...
      if (LddReturnValue == E_OK)
      {
        ...
        LddReturnValue = HSM_RsaPkcs1PssSignUpdate(
          &Cry_GddHaeHsmPkcs1PssSha256GenerateContext,
          LaaSha256ResultBuffer, LpPkcs1PssData->pSalt, LpPkcs1PssData->ulSaltLength);
        ...
        if (LddReturnValue == E_OK)
        {
          ...
          do
          {
            LddReturnValue = HSM_WaitResp(Cry_GddHaeHsmPkcs1PssSha256GenerateContext.jobId);
            LulTimeout++;
          } while ((LddReturnValue == HSM_E_WAIT) && (LulTimeout < CRYPTOLIB_HAE_HSM_TIMEOUT));

          if (LddReturnValue != E_OK)
          {
            (void)HSM_CancelJob(Cry_GddHaeHsmPkcs1PssSha256GenerateContext.jobId);
          }
        }
      }
    ...
    {
      Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pDataPtr = dataPtr;
      Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ulDataLength = dataLength;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1PssSha256GenerateFinish              **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Function(s) invoked :                               **
**                        Csm_SignatureGenerateServiceHasCallback,            **
**                        HSM_RsaPkcs1PssSignFinish                           **
**                        HSM_HaeGetErrorCode                                 **
*******************************************************************************/
/* polyspace MISRA-C3:5.1 [Justified:Low] "Follow AUTOSAR standard naming rules" */
Std_ReturnType Cry_HaeHsmPkcs1PssSha256GenerateFinish(Csm_ConfigIdType cfgId,
  uint8* resultPtr, uint32 *resultLengthPtr)
{
  ...
  if (JOB_DONE == Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState)
  {
    Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState = JOB_FINISH;
    ...
    if (Csm_SignatureGenerateServiceHasCallback() == FALSE)
    {
      ...
      if (LddReturnValue == E_OK)
      {
        LddReturnValue = HSM_RsaPkcs1PssSignFinish(
          &Cry_GddHaeHsmPkcs1PssSha256GenerateContext,
          resultPtr);
    ...
    {
      Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultPtr = resultPtr;
      Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultLengthPtr = resultLengthPtr;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmPkcs1PssSha256GenerateMainFunction        **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Cry_HaeHsmPkcs1PssSha256GenerateStart() or          **
**                        Cry_HaeHsmPkcs1PssSha256GenerateUpdate(). For       **
**                        Cry_HaeHsmPkcs1PssSha256GenerateFinish invocation of**
...
**                                                                            **
**                        Function(s) invoked :                               **
**                        HSM_RsaPkcs1PssSignStart, HSM_WaitResp,             **
**                        HSM_Sha256Start, HSM_Sha256Update, HSM_Sha256Finish,**
**                        HaeHsmSha256_Finish,                                **
**                        HaeHsmPkcs1Pss_Sign, HaeHsmCallback_setFunction,    **
**                        Csm_SignatureGenerateCallbackNotification,          **
...
*******************************************************************************/
/* polyspace MISRA-C3:5.1 [Justified:Low] "Follow AUTOSAR standard naming rules" */
void Cry_HaeHsmPkcs1PssSha256GenerateMainFunction(void)
{
  Std_ReturnType LddReturnValue;
  uint16 LusKeyNum;
  HSMAPI_CTX_t LddHaeHsmSha256Context;
  ...
  switch (Cry_GddHaeHsmPkcs1PssSha256GenerateTb.ucJobState)
  {
  case JOB_START:
    LusKeyNum = CSM_ZERO;
    /* polyspace +10 RTE:IDP [Justified:Low] "No Impact of this rule violation" */
    /* polyspace +10 MISRA-C3:18.1,D4.1 RTE:IDP [Justified:Low] "No Impact of this rule violation" */
    if (Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr->length == CSM_ONE)
    {
      LusKeyNum = Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr->data[CSM_ZERO];
    }
    else if (Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr->length == CSM_TWO)
    {
      LusKeyNum = Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr->data[CSM_ZERO];
      /* polyspace +1 MISRA-C3:10.6,10.7,12.2 [Justified:Low] "No Impact of this rule violation" */
      LusKeyNum |= (Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pPrivateKeyPtr->data[CSM_ONE]) << 8;
    }
    else
    {
      LddReturnValue = E_NOT_OK;
  ...
  case JOB_UPDATE:
    ...
    /* polyspace +1 MISRA-C3:11.3 [Justified:Low] "No Impact of this rule violation" */
    LpPkcs1PssData = (const Csm_HaeHsmPkcs1PssDataType*)Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pDataPtr;
  ...
  case JOB_FINISH:
    ...
    if (*(Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultLengthPtr) < HAC_RSA_BYTES_SIZE)
    {
      LddReturnValue = CSM_E_SMALL_BUFFER;
    }
    ...
    if (LddReturnValue == E_OK)
    {
      LddReturnValue = HSM_RsaPkcs1PssSignFinish(
        &Cry_GddHaeHsmPkcs1PssSha256GenerateContext,
        (uint8*)(Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultPtr));

      if (LddReturnValue == E_OK)
      {
        *(Cry_GddHaeHsmPkcs1PssSha256GenerateTb.pResultLengthPtr)
          = HAC_RSA_BYTES_SIZE;
      }
      else
      {
...
#endif /* (CSM_SIGNATURE_HAEHSMPKCS1PSSSHA256GENERATE == STD_ON) */
