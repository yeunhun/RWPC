...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmCmacAesVerify.h                                     **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_HAEHSMCMACAESVERIFY_H
#define CRY_HAEHSMCMACAESVERIFY_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaeHsmCmacAesVerifyStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr);

extern Std_ReturnType Cry_HaeHsmCmacAesVerifyUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_HaeHsmCmacAesVerifyFinish(Csm_ConfigIdType cfgId,
  const uint8* MacPtr, uint32 MacLength, Csm_VerifyResultType* resultPtr);

extern void Cry_HaeHsmCmacAesVerifyMainFunction(void);
...
#endif /* CRY_HAEHSMCMACAESVERIFY_H */
