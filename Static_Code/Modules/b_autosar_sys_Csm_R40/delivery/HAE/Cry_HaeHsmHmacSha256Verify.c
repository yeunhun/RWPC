...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmHmacSha256Verify.c                                  **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
**  PRODUCT   : AUTOSAR Crypto Service Manager Module                         **
**                                                                            **
**  PURPOSE   : Implementation of CRY HAE HSM HMAC SHA256 Verify Interface    **
**                                                                            **
...
**                      Include Section                                       **
*******************************************************************************/
/* Header File for HAE HSM HMAC SHA256 Verify */
#include "Cry_HaeHsmHmacSha256Verify.h"
/* Mac Interface */
...
**                      Global Data Types                                     **
*******************************************************************************/
/* Cry HaeHsmHmacSha256Verify Transfer buffer*/
typedef struct
{
  /* Define job state */
  uint8 ucJobState;
...
} Cry_HaeHsmHmacSha256VerifyTransferBuffer;
...
static HSMAPI_CTX_t Cry_GddHaeHsmHmacSha256VerifyContext;

static Cry_HaeHsmHmacSha256VerifyTransferBuffer Cry_GddHaeHsmHmacSha256VerifyTb;
...
#include "MemMap.h"
/*******************************************************************************
** Function Name      : Cry_HaeHsmHmacSha256VerifyInit                        **
**                                                                            **
** Service ID         : None                                                  **
**                                                                            **
...
**                      Cry_GddHaeHsmHmacSha256VerifyTb,                      **
**                      Cry_GddHaeHsmHmacSha256VerifyContext,                 **
**                                                                            **
**                      Function(s) invoked: None                             **
*******************************************************************************/
void Cry_HaeHsmHmacSha256VerifyInit(void)
{
  Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState = NO_JOB;
  Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr = NULL_PTR;
  Cry_GddHaeHsmHmacSha256VerifyTb.pDataPtr = NULL_PTR;
  Cry_GddHaeHsmHmacSha256VerifyTb.ulDataLength = CSM_ZERO;
  Cry_GddHaeHsmHmacSha256VerifyTb.pMacPtr = NULL_PTR;
  Cry_GddHaeHsmHmacSha256VerifyTb.ulMacLength = CSM_ZERO;
  Cry_GddHaeHsmHmacSha256VerifyTb.pResultPtr = NULL_PTR;

  (void)memset((void*)&Cry_GddHaeHsmHmacSha256VerifyContext, 0x00,
    sizeof(HSMAPI_CTX_t));
}

/*******************************************************************************
** Function Name        : Cry_HaeHsmHmacSha256VerifyStart                     **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
** Description          : Synchronous: This function initializes the          **
**                        computation of HAE HSM HMAC SHA256, so that if is   **
**                        able to process the input data                      **
**                        Asynchronous: This function shall store the         **
**                        provided in the arguments so that                   **
**                        Cry_HaeHsmHmacSha256VerifyMainFunction() can process**
**                        initialisation                                      **
**                                                                            **
...
*******************************************************************************/
Std_ReturnType Cry_HaeHsmHmacSha256VerifyStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr)
{
  ...
  if (NO_JOB == Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState)
  {
    Cry_HaeHsmHmacSha256VerifyInit();

    Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState = JOB_START;
    ...
    if (Csm_MacVerifyServiceHasCallback() == FALSE)
    {
      ...
      if (LddReturnValue == E_OK)
      {
        Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState = JOB_DONE;
      }
      else
      {
        Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState = NO_JOB;
    ...
    {
      Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr = keyPtr;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmHmacSha256VerifyUpdate                    **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
*******************************************************************************/
Std_ReturnType Cry_HaeHsmHmacSha256VerifyUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength)
{
  ...
  if (JOB_DONE == Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState)
  {
    Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState = JOB_UPDATE;
    ...
    if (Csm_MacVerifyServiceHasCallback() == FALSE)
    {
      ...
      while (LulRemainingLength > CSM_ZERO)
      {
        ...
        LddReturnValue = HSM_HmacSha256Update(&Cry_GddHaeHsmHmacSha256VerifyContext,
        ...
        if (LddReturnValue == E_OK)
        {
          ...
          do
          {
            LddReturnValue = HSM_WaitResp(Cry_GddHaeHsmHmacSha256VerifyContext.jobId);
            LulTimeout++;
          ...
          else
          {
            ...
            (void)HSM_CancelJob(Cry_GddHaeHsmHmacSha256VerifyContext.jobId);
          }
        }
        else
        {
    ...
    {
      Cry_GddHaeHsmHmacSha256VerifyTb.pDataPtr = dataPtr;
      Cry_GddHaeHsmHmacSha256VerifyTb.ulDataLength = dataLength;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmHmacSha256VerifyFinish                    **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Asynchronous: This function shall store the         **
**                        information given in the arguments, so that         **
**                        Cry_HaeHsmHmacSha256VerifyMainFunction() can finish **
...
*******************************************************************************/
Std_ReturnType Cry_HaeHsmHmacSha256VerifyFinish(Csm_ConfigIdType cfgId,
  const uint8* MacPtr, uint32 MacLength, Csm_VerifyResultType* resultPtr)
{
  ...
  if (JOB_DONE == Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState)
  {
    Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState = JOB_FINISH;
    ...
    if (Csm_MacVerifyServiceHasCallback() == FALSE)
    {
      ...
      LddReturnValue = HSM_HmacSha256Finish(
        &Cry_GddHaeHsmHmacSha256VerifyContext, LaaHmacSha256Digest);

      if (LddReturnValue == E_OK)
      {
        if (LulMacLength > SHA256_DIGEST_SIZE * CSM_EIGHT)
        {
          LulMacLength = SHA256_DIGEST_SIZE * CSM_EIGHT;
        }
        ...
        {
          /* polyspace +1 MISRA-C3:D4.14,18.1,D4.1 RTE:IDP [Justified:Low] "The pointer is checked" */
          if (MacPtr[LulIndex] != LaaHmacSha256Digest[LulIndex])
          {
            LblResult = CSM_FALSE;
            break;
          }
          ...
          && ((LulMacLength % CSM_EIGHT) > CSM_ZERO) )
        {
          for (LulIndex = CSM_ZERO; LulIndex < (LulMacLength % CSM_EIGHT); LulIndex++)
          {
            ...
            if ((MacPtr[LulMacLength / CSM_EIGHT] & (uint8)(CSM_ONE << (CSM_EIGHT - LulIndex - CSM_ONE)))
              != (LaaHmacSha256Digest[LulMacLength / CSM_EIGHT] & (uint8)(CSM_ONE << (CSM_EIGHT - LulIndex - CSM_ONE))))
            {
              LblResult = CSM_FALSE;
              break;
            }
    ...
    {
      Cry_GddHaeHsmHmacSha256VerifyTb.pMacPtr = MacPtr;
      Cry_GddHaeHsmHmacSha256VerifyTb.ulMacLength = MacLength;
      Cry_GddHaeHsmHmacSha256VerifyTb.pResultPtr = resultPtr;
    }
  }
  else
  {
...
/*******************************************************************************
** Function Name        : Cry_HaeHsmHmacSha256VerifyMainFunction              **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
...
**                        Cry_HaeHsmHmacSha256VerifyStart() or                **
**                        Cry_HaeHsmHmacSha256VerifyUpdate(). For             **
**                        Cry_HaeHsmHmacSha256VerifyFinish invocation of      **
...
*******************************************************************************/
void Cry_HaeHsmHmacSha256VerifyMainFunction(void)
{
  Std_ReturnType LddReturnValue;
  uint16 LusKeyNum;
	uint32 LulTimeout;
  ...
  switch (Cry_GddHaeHsmHmacSha256VerifyTb.ucJobState)
  {
  case JOB_START:
    LusKeyNum = CSM_ZERO;
    ...
    if (Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr->length == CSM_ONE)
    {
      LusKeyNum = Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr->data[CSM_ZERO];
    }
    else if (Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr->length == CSM_TWO)
    {
      LusKeyNum = Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr->data[CSM_ZERO];
      /* polyspace +1 MISRA-C3:10.6,10.7,12.2 [Justified:Low] "No Impact of this rule violation" */
      LusKeyNum |= (Cry_GddHaeHsmHmacSha256VerifyTb.pKeyPtr->data[CSM_ONE]) << 8;
    }
    else
    {
      LddReturnValue = E_NOT_OK;
  ...
  case JOB_UPDATE:
    ...
    LulRemainingLength = Cry_GddHaeHsmHmacSha256VerifyTb.ulDataLength;
    LpData = Cry_GddHaeHsmHmacSha256VerifyTb.pDataPtr;
  ...
  case JOB_FINISH:
    ...
    if (LddReturnValue == E_OK)
    {
      LulMacLength = Cry_GddHaeHsmHmacSha256VerifyTb.ulMacLength;
      LpData = Cry_GddHaeHsmHmacSha256VerifyTb.pMacPtr;
	...
	/* polyspace +2 MISRA-C3:18.1,D4.1 RTE:IDP [Justified:Low] "No Impact of this rule violation" */
        if (LpData[LulIndex] != LaaHmacSha256Digest[LulIndex])
        {
          LblResult = CSM_FALSE;
          break;
        }
      ...
      if (LblResult == CSM_TRUE)
      {
        *(Cry_GddHaeHsmHmacSha256VerifyTb.pResultPtr) = CSM_E_VER_OK;
      }
      else
      {
        *(Cry_GddHaeHsmHmacSha256VerifyTb.pResultPtr) = CSM_E_VER_NOT_OK;
      }
    }
    else
    {
