...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmCmacAesGenerate.h                                   **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_HAEHSMCMACAESGENERATE_H
#define CRY_HAEHSMCMACAESGENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaeHsmCmacAesGenerateStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr);

extern Std_ReturnType Cry_HaeHsmCmacAesGenerateUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_HaeHsmCmacAesGenerateFinish(Csm_ConfigIdType cfgId,
  uint8* resultPtr, uint32* resultLengthPtr, boolean TruncationIsAllowed);

extern void Cry_HaeHsmCmacAesGenerateMainFunction(void);
...
#endif /* CRY_HAEHSMCMACAESGENERATE_H */
