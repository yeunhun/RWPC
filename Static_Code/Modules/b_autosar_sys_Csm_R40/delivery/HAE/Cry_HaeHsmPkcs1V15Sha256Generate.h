...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmPkcs1V15Sha256Generate.h                            **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
**                - HAE HSM Pkcs1V15 Sha256 Generate                          **
**                                                                            **
...
#ifndef CRY_HAEHSMPKCS1V15SHA256GENERATE_H
#define CRY_HAEHSMPKCS1V15SHA256GENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaeHsmPkcs1V15Sha256GenerateStart(const void* cfgPtr,
  const Csm_AsymPrivateKeyType* keyPtr);

extern Std_ReturnType Cry_HaeHsmPkcs1V15Sha256GenerateUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_HaeHsmPkcs1V15Sha256GenerateFinish(Csm_ConfigIdType cfgId,
  uint8* resultPtr, uint32* resultLengthPtr);

extern void Cry_HaeHsmPkcs1V15Sha256GenerateMainFunction(void);
...
#endif /* CRY_HAEHSMPKCS1V15SHA256GENERATE_H */
