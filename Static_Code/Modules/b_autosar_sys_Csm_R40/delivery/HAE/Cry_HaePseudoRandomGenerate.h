...
**                                                                            **
**  SRC-MODULE: Cry_HaePseudoRandomGenerate.h                                 **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
**                - Autoever Pseudo Random Generate                           **
**                                                                            **
...
#ifndef CRY_HAEPSEUDORANDOMGENERATE_H
#define CRY_HAEPSEUDORANDOMGENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaePseudoRandomGenerate(const void* cfgPtr,
  uint8* resultPtr, uint32 resultLength);

extern void Cry_HaePseudoRandomGenerateMainFunction(void);
...
#endif /* CRY_HAEPSEUDORANDOMGENERATE_H */
