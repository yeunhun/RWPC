...
**                                                                            **
**  SRC-MODULE: Cry_HaeHsmPkcs1V15Sha1SeedVerify.h                            **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_HAEHSMPKCS1V15SHA1SEEDVERIFY_H
#define CRY_HAEHSMPKCS1V15SHA1SEEDVERIFY_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_HaeHsmPkcs1V15Sha1SeedVerifyStart(const void* cfgPtr,
  const Csm_AsymPublicKeyType* keyPtr);

extern Std_ReturnType Cry_HaeHsmPkcs1V15Sha1SeedVerifyUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_HaeHsmPkcs1V15Sha1SeedVerifyFinish(Csm_ConfigIdType cfgId,
  const uint8* signaturePtr, uint32 signatureLength,
  Csm_VerifyResultType* resultPtr);

extern void Cry_HaeHsmPkcs1V15Sha1SeedVerifyMainFunction(void);
...
#endif /* CRY_HAEHSMPKCS1V15SHA1SEEDVERIFY_H */
