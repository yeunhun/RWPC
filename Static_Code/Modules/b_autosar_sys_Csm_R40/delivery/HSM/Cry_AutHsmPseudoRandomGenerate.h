...
**                                                                            **
**  SRC-MODULE: Cry_AutHsmPseudoRandomGenerate.h                              **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_AUTHSMPSEUDORANDOMGENERATE_H
#define CRY_AUTHSMPSEUDORANDOMGENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_AutHsmPseudoRandomGenerate(const void* cfgPtr,
  uint8* resultPtr, uint32 resultLength);

extern void Cry_AutHsmPseudoRandomGenerateMainFunction(void);
...
#endif /* CRY_AUTHSMPSEUDORANDOMGENERATE_H */
