...
**                                                                            **
**  SRC-MODULE: Cry_AutRandomGenerate.h                                       **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_AUTRANDOMGENERATE_H
#define CRY_AUTRANDOMGENERATE_H
...
*******************************************************************************/
extern Std_ReturnType Cry_AutRandomGenerate(const void* cfgPtr,
  uint8* resultPtr, uint32 resultLength);

extern void Cry_AutRandomGenerateMainFunction(void);

#define CSM_STOP_SEC_CODE
#include "MemMap.h"

#endif /* (CSM_RANDOM_AUTRANDOMGENERATE == STD_ON) */
#endif /* (CSM_RANDOM_GENERATE_STATUS == STD_ON)  */

#endif /* CRY_AUTRANDOMGENERATE_H */
