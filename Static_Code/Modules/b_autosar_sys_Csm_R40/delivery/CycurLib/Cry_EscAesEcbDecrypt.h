...
**                                                                            **
**  SRC-MODULE: Cry_EscAesEcbDecrypt.h                                        **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_ESCAESECBDECRYPT_H
#define CRY_ESCAESECBDECRYPT_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_EscAesEcbDecryptStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr);

extern Std_ReturnType Cry_EscAesEcbDecryptUpdate(Csm_ConfigIdType cfgId,
  const uint8* cipherTextPtr, uint32 cipherTextLength, uint8* plainTextPtr,
  uint32* plainTextLengthPtr);

extern Std_ReturnType Cry_EscAesEcbDecryptFinish(Csm_ConfigIdType cfgId);

extern void Cry_EscAesEcbDecryptMainFunction(void);
