...
**                                                                            **
**  SRC-MODULE: Cry_EscPkcs1V15Sha1Generate.h                                 **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
**                - Escrypt Pkcs1V15 Sha1 Generate                            **
**                                                                            **
...
#ifndef CRY_ESCPKCS1V15SHA1GENERATE_H
#define CRY_ESCPKCS1V15SHA1GENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_EscPkcs1V15Sha1GenerateStart(const void* cfgPtr,
  const Csm_AsymPrivateKeyType* keyPtr);

extern Std_ReturnType Cry_EscPkcs1V15Sha1GenerateUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_EscPkcs1V15Sha1GenerateFinish(Csm_ConfigIdType cfgId,
  uint8* resultPtr, uint32* resultLengthPtr);

extern void Cry_EscPkcs1V15Sha1GenerateMainFunction(void);
...
#endif /* CRY_ESCPKCS1V15SHA1GENERATE_H */
