...
**                                                                            **
**  SRC-MODULE: Cry_EscHmacSha1Generate.h                                     **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_ESCHMACSHA1GENERATE_H
#define CRY_ESCHMACSHA1GENERATE_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_EscHmacSha1GenerateStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr);

extern Std_ReturnType Cry_EscHmacSha1GenerateUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_EscHmacSha1GenerateFinish(Csm_ConfigIdType cfgId,
  uint8* resultPtr, uint32* resultLengthPtr, boolean TruncationIsAllowed);

extern void Cry_EscHmacSha1GenerateMainFunction(void);
...
#endif /* CRY_ESCHMACSHA1GENERATE_H */
