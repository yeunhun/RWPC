...
**                                                                            **
**  SRC-MODULE: Cry_EscAesEcbEncrypt.h                                        **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
** 1.0.6     09-Aug-2016   Sinil        Redmine #5693, #5695                  **
...
#ifndef CRY_ESCAESECBENCRYPT_H
#define CRY_ESCAESECBENCRYPT_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_EscAesEcbEncryptStart(const void* cfgPtr,
  const Csm_SymKeyType* keyPtr);

extern Std_ReturnType Cry_EscAesEcbEncryptUpdate(Csm_ConfigIdType cfgId,
  const uint8* plainTextPtr, uint32 plainTextLength, uint8* cipherTextPtr,
  uint32* cipherTextLengthPtr);

extern Std_ReturnType Cry_EscAesEcbEncryptFinish(Csm_ConfigIdType cfgId);

extern void Cry_EscAesEcbEncryptMainFunction(void);
