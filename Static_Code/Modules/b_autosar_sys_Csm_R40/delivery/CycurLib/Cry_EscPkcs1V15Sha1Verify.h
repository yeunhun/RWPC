...
**                                                                            **
**  SRC-MODULE: Cry_EscPkcs1V15Sha1Verify.h                                   **
**                                                                            **
**  TARGET    : All                                                           **
**                                                                            **
...
#ifndef CRY_ESCPKCS1V15SHA1VERIFY_H
#define CRY_ESCPKCS1V15SHA1VERIFY_H
/*******************************************************************************
**                      Include Section                                       **
*******************************************************************************/
#include "Csm_Types.h"
...
extern Std_ReturnType Cry_EscPkcs1V15Sha1VerifyStart(const void* cfgPtr,
  const Csm_AsymPublicKeyType* keyPtr);

extern Std_ReturnType Cry_EscPkcs1V15Sha1VerifyUpdate(Csm_ConfigIdType cfgId,
  const uint8* dataPtr, uint32 dataLength);

extern Std_ReturnType Cry_EscPkcs1V15Sha1VerifyFinish(Csm_ConfigIdType cfgId,
  const uint8* signaturePtr, uint32 signatureLength,
  Csm_VerifyResultType* resultPtr);

extern void Cry_EscPkcs1V15Sha1VerifyMainFunction(void);
...
#endif /* CRY_ESCPKCS1V15SHA1VERIFY_H */
