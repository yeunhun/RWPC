...
extern VAR(EcuM_WakeupStatusType, ECUM_VAR_POWER_ON_INIT)
...
extern VAR(uint8, ECUM_VAR_POWER_ON_INIT) EcuM_GucRunRequestStatus;

/* Global pointer to hold EcuM Sleep Mode Index data */
extern VAR(uint8, ECUM_VAR_POWER_ON_INIT) EcuM_GucSleepModeIndex;
...
/* Global variable to store the shutdown status of EcuM */
extern VAR(uint16, ECUM_VAR_POWER_ON_INIT) EcuM_GaaWakeupCounter[ECUM_NO_OF_WAKEUPSOURCES];

/* Global pointer to hold EcuM Sleep Mode Index data */
extern VAR(uint16, ECUM_VAR_POWER_ON_INIT) EcuM_GusSleepModeId;
...
extern VAR(uint32, ECUM_VAR_POWER_ON_INIT) EcuM_GulPllCnt;
...
extern VAR(uint8, ECUM_VAR_NOINIT) EcuM_GulPbVariantIndex;
#endif
