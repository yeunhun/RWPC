...
**                                                                            **
** 1.1.0    14-12-2018    EunKyung.Kim    Changes made As per Redmine #8561   **
**                                                                            **
** 1.0.5    12-12-2018    YoungJin.Yun    Changes made As per Redmine #14900  **
**                                                                            **
** 1.0.4    07-12-2018    EunKyung.Kim    Changes made As per Redmine #14991  **
**                                                                            **
** 1.0.3    31-10-2018    EunKyung.Kim    Changes made As per Redmine #14462  **
**                                                                            **
...
const Dem_NumOfEventMemoryEntryType Dem_Num_Of_Permanent_EventMemory_NvBlockId = DEM_NUM_OF_PERMANENT_EVENTMEMORY_NVBLOCKID;
#endif
...
const Dem_NumOfJ1939FreezeFrameClassType Dem_Num_Of_J1939FreezeFrameClass = DEM_NUM_OF_J1939FREEZEFRAMECLASS;
#endif
#endif
...
const uint16 Dem_Max_ListOfEnableConditionId = DEM_MAX_LISTOFENABLECONDITIONID;
#endif

#ifdef DEM_MAX_LISTOFSTORAGECONDITIONID
const uint16 Dem_Max_ListOfStorageConditionId = DEM_MAX_LISTOFSTORAGECONDITIONID;
#endif
...
#ifdef DEM_NUMBER_OF_RATIO_INFO
const uint16 Dem_Num_Ratio_Info = DEM_NUMBER_OF_RATIO_INFO;
#endif
...
#ifdef DEM_NUM_OF_INDICATORID
uint8 Dem_Num_Of_IndicatorId = DEM_NUM_OF_INDICATORID;
#endif
...
{
  /* polyspace +2 MISRA-C3:5.8 [Justified:Low] "Not a defect" */  
  /* polyspace +1 MISRA-C3:5.3 [Justified:Low] "Not a defect" */  
...
Dem_ClearSinglePrestoredFFbyEventId(Dem_EventIdType EventId)
{
  ...
  #endif
  {
    ...
    /* polyspace +5 MISRA-C3:D4.1 [Justified:Low] "Not a defect" */
    /* polyspace +4 MISRA-C3:18.1 [Justified:Low] "Not a defect" */
...
Dem_InitStorageConditionStatus(void)
{
  ...
  for(storIndex = DEM_ZERO; storIndex < Dem_Number_Storage_Condition; storIndex++)
  {
    Dem_GaaStorageConditionStatus[storIndex] = Dem_GaaStorageCondition[storIndex];
  }
  #endif
}
...
Dem_GetStorageConditionStatus(uint16 storIndex)
{
  ...
  status = Dem_GaaStorageConditionStatus[Dem_ListOfStorageConditionId[storIndex]];
  #endif
...
Dem_InitEnableConditionStatus(void)
{
  ...
  for(condIndex = 0u; condIndex < Dem_Num_Enable_Condition; condIndex++)
  {
    /* polyspace +2 MISRA-C3:D4.1 [Justified:Low] "Not a defect" */  
    /* polyspace +1 MISRA-C3:18.1 [Justified:Low] "Not a defect" */  
    Dem_EnableConditionStatus[condIndex] = Dem_GaaEnableCondition[condIndex];
  }
  #endif
}
...
Dem_GetEnableConditionStatus(uint16 condIndex)
{
  ...
  status = Dem_EnableConditionStatus[Dem_ListOfEnableConditionId[condIndex]];
  #endif
