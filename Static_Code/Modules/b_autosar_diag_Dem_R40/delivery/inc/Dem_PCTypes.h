...
**                                                                            **
** 1.6.2    25-04-2019    EunKyung.Kim    Changes made As per Redmine #16385  **
**                                                                            **
** 1.6.1    31-01-2019    EunKyung.Kim    Changes made As per Redmine #15936  **
**                                                                            **
** 1.6.0    14-12-2018    EunKyung.Kim    Changes made As per Redmine #8561   **
**                                                                            **
** 1.5.2    12-12-2018    YoungJin.Yun    Changes made As per Redmine #14900  **
**                                                                            **
** 1.5.1    09-11-2018      EunKyung.Kim  Changes made As per Redmine #14481  **
**                                                                            **
...
/* polyspace-begin MISRA-C3:8.6 [Justified:Low] "Not a defect" */
...
typedef struct STag_Dem_RatioIdInfo
{
  ...
  /* Number of SecondaryFunctionIdRef */
  uint16 ucNumofSecFid;
 ...
 *******************************************************************************/
typedef struct STag_Dem_EventParameterCallbackType
{
  ...
  (Dem_InitMonitorReasonType InitMonitorReason);
} Dem_EventParameterCallbackType;
...
typedef struct STag_Dem_EventParameterType 
{
  ...
  Dem_NumOfEventCallbackDataType e_PointToEventCallbackData;
   ...
   *
   * Bit 6-7  : Reset WIR                             TRUE/FALSE
   */   
  uint8 ParamFieldsA;

  /* Bit 0  : Event Clear                      TRUE/FALSE         
  */
...
{ 
  ...
  uint16 IumprDenominator[DEM_SIXTEEN];
  uint16 IumprNumerator[DEM_SIXTEEN];
  ...
  uint8 AttributeStatus[DEM_BITARRAY_BITNSLOTS(1U+DEM_NUM_OF_INDICATOR_ATTRIBUTE_STATUS)];
  #endif

/*
  #if ((DEM_OBD_SUPPORT == STD_ON) && (DEM_NUMBER_OF_INDICATORS > 0U))
  uint8 IndicatorMilCounter[DEM_NUMBER_OF_INDICATORS];
  #endif
*/
...
#if (DEM_OBD_SUPPORT == STD_ON)
typedef struct STag_Dem_PerDtcStateType
{
  Dem_EventIdType EventIdRef;
...
/* Array Dem_PrimaryNvmBlockId */
extern CONST(NvM_BlockIdType, DEM_CONST) Dem_PermanentEventMemoryNvmBlockId[];
#endif
...
extern CONST(Dem_EventIdType, DEM_CONST) Dem_ListOfDtcNotAssignedEvents[]; 
...
extern CONST(Dem_J1939FreezeFrameClassType, DEM_CONST) Dem_J1939FreezeFrameClass[];
#endif
#endif
...
#if (DEM_NUMBER_OF_EVENT_CALLBACK > 0U)
extern CONST(Dem_EventParameterCallbackType, DEM_CONST) Dem_EventCallback[];
#endif
...
#if (DEM_J1939_SUPPORT == STD_ON)
#if (DEM_SIZE_OF_J1939FREEZEFRAME > 0U)
extern CONST(Dem_SPNClassType, DEM_CONST) Dem_SPNClass[];
#endif
#endif
/********************************************************************/
#if (DEM_SIZE_OF_FREEZEFRAME > 0U)
...
#if (DEM_J1939_SUPPORT == STD_ON)
#if (DEM_SIZE_OF_J1939FREEZEFRAME > 0U)
extern CONST(Dem_NumOfSpnClassType, DEM_CONST) Dem_ListOfSPNClassIndex[];
#endif
#endif
...
extern CONST(Dem_EventIdType, DEM_CONST) Dem_ListOfOperationCycleEvents[];
...
typedef P2CONST(Dem_EventParameterCallbackType,AUTOMATIC,DEM_VAR) Dem_EventParameterCallbackPtrType;
...
/* polyspace-end MISRA-C3:8.6 [Justified:Low] "Not a defect" */
