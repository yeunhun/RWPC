...
**                                                                            **
** 1.6.3    16-02-2021    EunKyung.Kim    Changes made As per Redmine #28213  **
**                                                                            **
...
**                                                                            **
** 1.5.3    20-03-2018     EunKyung.Kim   Changes made As per Redmine #11177  **
**                                                                            **
...
#define DEM_EVPROCSTATE_J1939EXFF_FILTER                          (7U) /* (0x01U) */
...
#define DEM_EVMEM_STATUS_TRIGGER_WAIT_NVM                         ((uint8) 0x20) /* immediate storage : wait to put job in the NvM's queue  */
...
/* polyspace +3 MISRA-C3:10.3 [Justified:Low] "Not a defect" */
...
#define DEM_CONVERT_MIN_HR                                        (0.01667) /* @IF_REQ : float ? */
...
/* Iumpr Denominator groups */
#define DEM_IUMPR_DEN_500MILL                                     (0x00U)
#define DEM_IUMPR_DEN_COLDSTART                                   (0x01U)
#define DEM_IUMPR_DEN_EVAP                                        (0x02U)
#define DEM_IUMPR_DEN_NONE                                        (0x03U)
...
#define DEM_IUMPR_MAX_CONDITION_NUMBER                            (0x04U)

#define DEM_J1939RDY_DISABLE_MISF                           ((uint8)0x01)
#define DEM_J1939RDY_DISABLE_AC                             ((uint8)0x02)
#define DEM_J1939RDY_DISABLE_BOOSTPR                        ((uint8)0x04)
#define DEM_J1939RDY_DISABLE_CAT                            ((uint8)0x08)
#define DEM_J1939RDY_DISABLE_CMPRCMPT                       ((uint8)0x10)
#define DEM_J1939RDY_DISABLE_EGSENS                         ((uint8)0x20)
#define DEM_J1939RDY_DISABLE_EGR                            ((uint8)0x40)
#define DEM_J1939RDY_DISABLE_EVAP                           ((uint8)0x80)
#define DEM_J1939RDY_DISABLE_FLSYS                          ((uint16)0x100)
#define DEM_J1939RDY_DISABLE_HCCAT                          ((uint16)0x200)
#define DEM_J1939RDY_DISABLE_HTCAT                          ((uint16)0x400)
#define DEM_J1939RDY_DISABLE_NOXCAT                         ((uint16)0x800)
#define DEM_J1939RDY_DISABLE_O2SENS                         ((uint16)0x1000)
#define DEM_J1939RDY_DISABLE_O2SENSHT                       ((uint16)0x2000)
#define DEM_J1939RDY_DISABLE_PMFLT                          ((uint16)0x4000)
#define DEM_J1939RDY_DISABLE_SECAIR                         ((uint16)0x8000)
...
#define DEM_PREINIT2                                              (0x02U)
#define DEM_READNVDATA                                            (0x03U)
#define DEM_INIT                                                  (0x04U)
/* AUTRON Specific */
#define DEM_DEINIT                                                (0x05U)
...
#define DEM_NO_EVENT_CALLBACK_DATA                                (DEM_NO_IDX_U16)
...
#if ((DEM_OBD_SUPPORT == STD_ON) && (DEM_MAX_NUMBER_OF_PID_DATAELEMENT>0))
...
#define DEM_EVENTPARAM_EVENT_CLEAR_MASK                           (0x01U) /* 0000 0001 */
...
#define DEM_EVENTPARAM_EVENT_CLEAR_POS                             (0U)
...
/* polyspace +8 MISRA-C3:10.5 [Justified:Low] "Not a defect" */
...
/* polyspace +5 MISRA-C3:10.8 [Justified:Low] "Not a defect" */
...
#define DEM_GET_EVENTPARAM_EVENT_CLEAR(param)                      ((boolean)(((param) & DEM_EVENTPARAM_EVENT_CLEAR_MASK) >> DEM_EVENTPARAM_EVENT_CLEAR_POS))
...
#define DEM_CLEARDTC_STATE_RESET_EVENTS                           (0x08U)
...
typedef Dem_EventIdType Dem_NumOfEventCallbackDataType;
/* For OBD */
/* types of the pid,
...
#define DEM_OBD_RDY_NONE                                          ((uint8)0x0C)
#define DEM_OBD_RDY_NOXCAT                                        ((uint8)0x0D)
#define DEM_OBD_RDY_O2SENS                                        ((uint8)0x0E)
#define DEM_OBD_RDY_O2SENSHT                                      ((uint8)0x0F)
#define DEM_OBD_RDY_PMFLT                                         ((uint8)0x10)
#define DEM_OBD_RDY_SECAIR                                        ((uint8)0x11)
...
/* polyspace +4 MISRA-C3:20.9 [Justified:Low] "Not a defect" */
#if (\
...
#define DEM_CLR_UDSSTATUSBYTE(EventId, Mask)                      do{(Dem_AllEventStatusByte[(EventId)] &= (Dem_UdsStatusByteType)(0xFFU & ~(Dem_UdsStatusByteType)(Mask)));} while(0)
...
#define DEM_CLR_EVENTSTATUSBYTE(UdsStatusByte, Mask)                      do{((UdsStatusByte) &= (Dem_UdsStatusByteType)(0xFFU & ~(Dem_UdsStatusByteType)(Mask)));} while(0)
...
#define DEM_BITARRAY_BITGET(a, b)                                 (((a)[DEM_BITARRAY_BITSLOT(b)] >> ((b) % DEM_BYTE_BITS)) & 0x01U)
...
/* 4.2.1 ~ */
  ...
  #define DEM_NUM_OF_INDICATOR_BEHAVIOR                         (DEM_INDICATOR_SHORT+1)
#else 
  #if (DEM_J1939_SUPPORT == STD_ON)
    #define DEM_NUM_OF_INDICATOR_BEHAVIOR                       (DEM_INDICATOR_FAST_FLASH+1)
  #else
    #define DEM_NUM_OF_INDICATOR_BEHAVIOR                       (DEM_INDICATOR_BLINK_CONT+1)
  #endif
#endif  


  /*fix later*/
#define DEM_OBD2_SUPPORT    STD_OFF
