...
********************************************************************************
** 2.9.0.0   29-Nov-2021   HM Shin     #29925                                 **
...
/* AUTOEVER BUGFIX Definition - Enable Featuring */
#define AUTOEVER_LOCAL_BUG_FIX	
/*******************************************************************************
**                     Service Id's                                           **
*******************************************************************************/
...
#define PDUR_START_SEC_CODE
#include "MemMap.h"
extern FUNC(void, PDUR_CODE) PduR_DisableRouting(PduR_RoutingPathGroupIdType id);
...
extern FUNC(void, PDUR_VAR) PduR_GetRoutingPathGroupStatus(PduR_RoutingPathGroupIdType id, P2VAR(uint8, AUTOMATIC, PDUR_VAR) pStatus);
...
extern FUNC(PduR_GwBufferStatus, PDUR_CODE) PduR_GetGwBufferStatus(PduIdType LddPduRSrcPduId);
