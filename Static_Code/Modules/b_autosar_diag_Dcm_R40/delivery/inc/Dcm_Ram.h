...
**                                                                            **
** 1.0.11    25-03-2020    EunKyung Kim      #21551, #22622                   **
**                                                                            **
** 1.0.10    25-11-2019    EunKyung Kim      #19580                           **
**                                                                            **
** 1.0.9     02-09-2019    EunKyung Kim      #18790                           **
**                                                                            **
** 1.0.8     23-07-2019    Y.S     Jeon      #17172                           **
**                                                                            **
...
extern VAR(uint32, DCM_VAR) Dcm_GaaCRLLegnth;
#endif
...
extern VAR(uint32, DCM_VAR) Dcm_GaaTimer[DCM_MAX_TIMERS];
...
extern VAR(uint32, DCM_VAR) Dcm_GulRMBAMemorySize;
#endif

#if(DCM_WRITE_MEMORY_BY_ADDRESS_SERVICE == STD_ON)
/* Global Variable to store Memory Address for 0x23 service */
extern VAR(uint32, DCM_VAR) Dcm_GulWriteMemoryAddress;
extern VAR(uint32, DCM_VAR) Dcm_GulWriteMemorySize;
#endif
...
extern VAR(boolean, DCM_VAR)Dcm_GblTheFirstRequest;
...
extern VAR(boolean, DCM_VAR)Dcm_GblNegavieResStatus;
