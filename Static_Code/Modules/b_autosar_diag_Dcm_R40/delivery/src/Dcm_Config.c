...
/* polyspace-begin MISRA-C3:5.3 [Justified:Low] "Not a defect" */
/* polyspace-begin MISRA-C3:5.8 [Justified:Low] "Not a defect" */
...
CONST(uint8, DCM_CONST) Dcm_diag_Resp_Max_Num_Respend = DCM_DIAG_RESP_MAX_NUM_RESPEND;
#endif
...
FUNC(Dcm_ConfirmationFunType, DCM_CODE) Dcm_GetManuConfirmationFun(uint8 index)
{
  ...
  #else
  LpManuConfirmationFun = NULL_PTR;
  #endif
...
**                                                                            **
*******************************************************************************/
FUNC(Dcm_ConfirmationFunType, DCM_CODE) Dcm_GetSuppConfirmationFun(uint8 index)
{
  Dcm_ConfirmationFunType LpSuppConfirmationFun;
  
  #if(DCM_REQUEST_SUPPLIER_INDICATION_ENABLED == STD_ON)
  /* polyspace +4 RTE:OBAI [Justified:Low] "Not a defect" */
  ...
  LpSuppConfirmationFun = Dcm_GaaSuppIndConfigType[index].pSuppConfirmationFun;
  #else
  LpSuppConfirmationFun = NULL_PTR;
  #endif
...
**                                                                            **
*******************************************************************************/
FUNC(Dcm_IndicationFunType, DCM_CODE) Dcm_GetSuppIndicationFun(uint8 index)
{
  Dcm_IndicationFunType LpSuppIndicationFun;
  
  #if(DCM_REQUEST_SUPPLIER_INDICATION_ENABLED == STD_ON)
  /* polyspace +4  RTE:OBAI [Justified:Low] "Not a defect" */
  /* polyspace +3 RTE:NIVL [Justified:Low] "Not a defect" */
  /* polyspace +2 MISRA-C3:18.1 [Justified:Low] "Not a defect" */
  /* polyspace +1 MISRA-C3:D4.1 [Justified:Low] "Enter comment here" */
  LpSuppIndicationFun = Dcm_GaaSuppIndConfigType[index].pSuppIndicationFun;
  #else
  LpSuppIndicationFun = NULL_PTR;
  #endif
...
/* polyspace-end MISRA-C3:5.3 [Justified:Low] "Not a defect" */
/* polyspace-end MISRA-C3:5.8 [Justified:Low] "Not a defect" */
/*******************************************************************************
**                      End of File                                           **
*******************************************************************************/
