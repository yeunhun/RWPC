...
/**
 ******************************************************************************
 ** \fn Fee_InvalidateBlockLib
 **
 ** Library function to invalidate a block.
 **
 ** \param BlockNumber [in] - Number of the block which shall be invalidated.
 **
*****************************************************************************/
FUNC(Std_ReturnType, FEE_CODE) Fee_InvalidateBlockLib(
  ...
  VAR(Fee_BlockAttributeType, AUTOMATIC) BlkAttri)
{
    ...
    {
        FEE_STATE_SET(FEE_STAT_INVAL_WAIT_WRITE)                       /* change state */
    }
