 ...
 ** \fn Fee_WriteLib
 **
 ** Library function to write a block.
 **
 ** \param BlockNumber [in] - Number of the block to be written.
 ** \param DataBufferPtr [in] - Pointer to the buffer which contains the data to
 ** be written.
 **
*****************************************************************************/
FUNC(Std_ReturnType, FEE_CODE) Fee_WriteLib(
  ...
  VAR(Fee_BlockAttributeType, AUTOMATIC) BlkAttri)
{
    ...
    Fee_Job.DataBufferPtr.WriteBufferPtr  = DataBufferPtr;
    ...
    {
        FEE_STATE_SET(FEE_STAT_WRITE_WAIT_WRITE)                   /* change state */
    }
