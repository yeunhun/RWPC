...
#ifndef FEE_ERASEIMMEDIATEBLOCK_H_INCLUDED
#define FEE_ERASEIMMEDIATEBLOCK_H_INCLUDED
...
extern FUNC(Std_ReturnType, FEE_CODE) Fee_EraseImmediateBlockLib(
...
#endif /*!defined(FEE_ERASEIMMEDIATEBLOCK_H_INCLUDED)*/
