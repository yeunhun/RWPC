...
#ifndef FEE_GETSTATUS_H_INCLUDED
#define FEE_GETSTATUS_H_INCLUDED
...
extern FUNC(MemIf_StatusType, FEE_CODE) Fee_GetStatusLib(void);
...
#endif /*!defined(FEE_GETSTATUS_H_INCLUDED)*/
