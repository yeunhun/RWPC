...
#ifndef FEE_MAINFUNCTION_H_INCLUDED
#define FEE_MAINFUNCTION_H_INCLUDED
...
extern FUNC(void, FEE_CODE) Fee_MainFunctionLib(void);

#define FEE_STOP_SEC_CODE_ASIL_B
#include "Fee_MemMap.h"

#endif /*!defined(FEE_MAINFUNCTION_H_INCLUDED)*/
