...
#ifndef FEE_INVALIDATEBLOCK_H_INCLUDED
#define FEE_INVALIDATEBLOCK_H_INCLUDED
...
extern FUNC(Std_ReturnType, FEE_CODE) Fee_InvalidateBlockLib(
...
#endif /*!defined(FEE_INVALIDATEBLOCK_H_INCLUDED)*/
