...
#ifndef FEE_GETREMAININGPAGES_H_INCLUDED
#define FEE_GETREMAININGPAGES_H_INCLUDED
...
extern FUNC(uint32, FEE_CODE) Fee_GetRemainingPagesLib(
...
#endif /*!defined(FEE_GETREMAININGPAGES_H_INCLUDED)*/
