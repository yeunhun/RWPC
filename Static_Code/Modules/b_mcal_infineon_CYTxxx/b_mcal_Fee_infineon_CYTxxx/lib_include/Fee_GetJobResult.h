...
#ifndef FEE_GETJOBRESULT_H_INCLUDED
#define FEE_GETJOBRESULT_H_INCLUDED
...
extern FUNC(MemIf_JobResultType, FEE_CODE) Fee_GetJobResultLib(void);
...
#endif /*!defined(FEE_GETJOBRESULT_H_INCLUDED)*/
