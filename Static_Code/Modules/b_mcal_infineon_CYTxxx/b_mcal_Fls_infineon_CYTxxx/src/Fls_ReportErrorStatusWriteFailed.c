 ...
 ** function Fls_ReportErrorStatusWriteFailed.
 **
 ...
 ** \return     none
 */
FUNC(void, FLS_CODE) Fls_ReportErrorStatusWriteFailed
(
...
)
{
    ...
    {
        /* ASIL error callout. */
        FLS_ERROR_CALLOUT_FUNCTION(FLS_MODULE_ID, FLS_INSTANCE_ID, FLS_ID_MAINFUNCTION, FLS_E_WRITE_FAILED_FOR_CALLOUT);
#if ( FLS_RUNTIME_ERROR_DETECT == STD_ON )
        /* call DET */
        (void)Det_ReportRuntimeError(FLS_MODULE_ID, FLS_INSTANCE_ID, FLS_ID_MAINFUNCTION, FLS_E_WRITE_FAILED);
#endif /* FLS_RUNTIME_ERROR_DETECT == STD_ON */
    }
