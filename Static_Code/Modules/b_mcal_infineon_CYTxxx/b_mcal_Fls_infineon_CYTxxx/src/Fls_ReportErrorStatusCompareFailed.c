 ...
 ** function Fls_ReportErrorStatusCompareFailed.
 **
 ...
 ** \return     none
 */
FUNC(void, FLS_CODE) Fls_ReportErrorStatusCompareFailed
(
...
)
{
    ...
    {
        /* ASIL error callout. */
        FLS_ERROR_CALLOUT_FUNCTION(FLS_MODULE_ID, FLS_INSTANCE_ID, FLS_ID_MAINFUNCTION, FLS_E_COMPARE_FAILED_FOR_CALLOUT);
#if ( FLS_RUNTIME_ERROR_DETECT == STD_ON )
        /* call DET */
        (void)Det_ReportRuntimeError(FLS_MODULE_ID, FLS_INSTANCE_ID, FLS_ID_MAINFUNCTION, FLS_E_COMPARE_FAILED);
#endif /* FLS_RUNTIME_ERROR_DETECT == STD_ON */
    }
