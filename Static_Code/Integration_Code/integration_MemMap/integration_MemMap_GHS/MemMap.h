...
/*******************************************************************************
**  (C) 2014-2020 HYUNDAI AUTRON Co., Ltd.                                    **
...
/*                                 Slpwup                                     */
/* -------------------------------------------------------------------------- */
#elif defined (CDD_SLPWUP_START_SEC_CODE)
  #undef       CDD_SLPWUP_START_SEC_CODE

  #pragma ghs section text=".text.DEFAULT_CODE"
  #pragma ghs section rodata=".rodata.DEFAULT_ROM_CONST"
  #pragma ghs section bss=".bss.DEFAULT_RAM_VAR_CLEARED"
  #pragma ghs section data=".data.DEFAULT_RAM_VAR_INIT"
#elif defined (CDD_SLPWUP_STOP_SEC_CODE)
  #undef       CDD_SLPWUP_STOP_SEC_CODE
  #pragma ghs section

#elif defined (CDD_SLPWUP_START_SEC_VAR_CLEARED_UNSPECIFIED)
  #undef       CDD_SLPWUP_START_SEC_VAR_CLEARED_UNSPECIFIED

  #pragma ghs section bss=".bss.DEFAULT_RAM_VAR_CLEARED"
#elif defined (CDD_SLPWUP_STOP_SEC_VAR_CLEARED_UNSPECIFIED)
  #undef       CDD_SLPWUP_STOP_SEC_VAR_CLEARED_UNSPECIFIED
  #pragma ghs section

#elif defined (CDD_SLPWUP_START_SEC_CONST_UNSPECIFIED)
  #undef       CDD_SLPWUP_START_SEC_CONST_UNSPECIFIED

  #pragma ghs section rodata=".rodata.DEFAULT_ROM_CONST"
#elif defined (CDD_SLPWUP_STOP_SEC_CONST_UNSPECIFIED)
  #undef       CDD_SLPWUP_STOP_SEC_CONST_UNSPECIFIED
  #pragma ghs section
