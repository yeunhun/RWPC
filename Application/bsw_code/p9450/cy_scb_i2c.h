...
***************************************/
/**
* \addtogroup group_i2c_general_functions
* \{
*/
...
static inline void Cy_SCB_I2C_Enable(volatile stc_SCB_t *base);
...
static inline void Cy_SCB_I2C_MasterSetLowPhaseDutyCycle (volatile stc_SCB_t *base, uint32_t clockCycles);
static inline void Cy_SCB_I2C_MasterSetHighPhaseDutyCycle(volatile stc_SCB_t *base, uint32_t clockCycles);
...
* \{
*/
static inline void Cy_SCB_I2C_RegisterEventCallback(volatile stc_SCB_t const *base, scb_i2c_handle_events_t callback,
                                                      cy_stc_scb_i2c_context_t *context);
...
*
*******************************************************************************/
static inline void Cy_SCB_I2C_RegisterEventCallback(volatile stc_SCB_t const *base,
