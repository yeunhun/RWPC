...
#include "SWC_DiagnosticMonitor_MemMap.h"
uint8 Dem_CallbackTest_EventStatusChanged_ModeChangedLOCALCAN = 0;
uint8 Dem_CallbackTest_EventStatusChanged_ModeChangedBCAN = 0;
/*******************************************************************************
...
/*******************************************************************************
** Function Name        : CBStatusEvt_E_MODE_CHANGE_LOCALCAN                   **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
** Description          : Triggers on changes of the event status byte        **
...
** Remarks              :                                                     **
*******************************************************************************/
FUNC(Std_ReturnType, SWC_DiagnosticMonitor_CODE)  CBStatusEvt_E_MODE_CHANGE_LOCALCAN(
    IN VAR(Dem_EventStatusExtendedType, AUTOMATIC) EventStatusOld,
    IN VAR(Dem_EventStatusExtendedType, AUTOMATIC) EventStatusNew)
{
  volatile int i= 0;

  Dem_CallbackTest_EventStatusChanged_ModeChangedLOCALCAN = 1;

  return RTE_E_OK;
}

/*******************************************************************************
** Function Name        : CBStatusEvt_E_MODE_CHANGE_BCAN                   **
**                                                                            **
** Service ID           : None                                                **
**                                                                            **
** Description          : Triggers on changes of the event status byte        **
...
** Remarks              :                                                     **
*******************************************************************************/
FUNC(Std_ReturnType, SWC_DiagnosticMonitor_CODE)  CBStatusEvt_E_MODE_CHANGE_BCAN(
    IN VAR(Dem_EventStatusExtendedType, AUTOMATIC) EventStatusOld,
    IN VAR(Dem_EventStatusExtendedType, AUTOMATIC) EventStatusNew)
{
  volatile int i= 0;

  Dem_CallbackTest_EventStatusChanged_ModeChangedBCAN = 1;
...
FUNC(void, SWC_DiagnosticMonitor_CODE) DiagnosticMonitor(void)
{
  ...
  if (GetX(u1g_InhibitNormalBatt) == kOn)
  {
    Rte_Call_EnableCond_EnableCondtion_0_SetEnableCondition(FALSE);
  }
  else
  {
    Rte_Call_EnableCond_EnableCondtion_0_SetEnableCondition(TRUE);
  }
...
FUNC(void, SWC_DiagnosticMonitor_CODE) DiagnosticMonitor(void)
{
  ...
  switch(SwcDem_TestPhase)
  {
    ...
    case 14:
      LddRetVal = Rte_Call_Event_DEM_E_TEST_EVENT3_SetEventStatus(DEM_EVENT_STATUS_FAILED);
      if (RTE_E_OK != LddRetVal)
      {
        /* do something */
      }
    ...
    case 15:
      LddRetVal = Rte_Call_Event_DEM_E_TEST_EVENT4_SetEventStatus(DEM_EVENT_STATUS_FAILED);
      if (RTE_E_OK != LddRetVal)
      {
        /* do something */
      }
  ...
  if (SwcDem_TestPhase != 14U)
    SwcDem_TestPhase = 2U;
  else
    SwcDem_TestPhase = 15U;
